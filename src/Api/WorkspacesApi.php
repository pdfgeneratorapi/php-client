...
class WorkspacesApi
{
     ...
     * Create workspace
     *
     * @param  \PDFGeneratorAPI\Model\CreateWorkspaceRequest|null $create_workspace_request create_workspace_request (optional)
     ...
     * @return \PDFGeneratorAPI\Model\InlineObject8|\PDFGeneratorAPI\Model\InlineObject24|\PDFGeneratorAPI\Model\InlineObject25|\PDFGeneratorAPI\Model\InlineObject26|\PDFGeneratorAPI\Model\InlineObject27|\PDFGeneratorAPI\Model\InlineObject29|\PDFGeneratorAPI\Model\InlineObject30|\PDFGeneratorAPI\Model\InlineObject31
     */
     ...
     * Create workspace
     *
     * @param  \PDFGeneratorAPI\Model\CreateWorkspaceRequest|null $create_workspace_request (optional)
     * @param  string $contentType The value for the Content-Type header. Check self::contentTypes['createWorkspace'] to see the possible values for this operation
     *
     * @throws \PDFGeneratorAPI\ApiException on non-2xx response or if the response body is not in the expected format
     * @throws \InvalidArgumentException
     * @return array of \PDFGeneratorAPI\Model\InlineObject8|\PDFGeneratorAPI\Model\InlineObject24|\PDFGeneratorAPI\Model\InlineObject25|\PDFGeneratorAPI\Model\InlineObject26|\PDFGeneratorAPI\Model\InlineObject27|\PDFGeneratorAPI\Model\InlineObject29|\PDFGeneratorAPI\Model\InlineObject30|\PDFGeneratorAPI\Model\InlineObject31, HTTP status code, HTTP response headers (array of strings)
     */
            ...
            switch($statusCode) {
                case 201:
                    return $this->handleResponseWithDataType(
                        '\PDFGeneratorAPI\Model\InlineObject8',
                        $request,
                        $response,
                    );
                case 401:
    ...
    {
        $returnType = '\PDFGeneratorAPI\Model\InlineObject8';
        $request = $this->createWorkspaceRequest($create_workspace_request, $contentType);
    ...
    {
        $this->deleteWorkspaceWithHttpInfo($workspace_identifier, $contentType);
    }
     ...
     * @throws \PDFGeneratorAPI\ApiException on non-2xx response or if the response body is not in the expected format
     * @throws \InvalidArgumentException
     * @return array of \PDFGeneratorAPI\Model\InlineObject5|\PDFGeneratorAPI\Model\InlineObject24|\PDFGeneratorAPI\Model\InlineObject25|\PDFGeneratorAPI\Model\InlineObject26|\PDFGeneratorAPI\Model\InlineObject27|\PDFGeneratorAPI\Model\InlineObject29|\PDFGeneratorAPI\Model\InlineObject30|\PDFGeneratorAPI\Model\InlineObject31, HTTP status code, HTTP response headers (array of strings)
     */
    public function getWorkspacesWithHttpInfo($page = 1, $per_page = 15, string $contentType = self::contentTypes['getWorkspaces'][0])
    {
        ...
        try {
            ...
            switch($statusCode) {
                case 200:
                    return $this->handleResponseWithDataType(
                        '\PDFGeneratorAPI\Model\InlineObject5',
                        $request,
                        $response,
                    );
                case 401:
    ...
    {
        $returnType = '\PDFGeneratorAPI\Model\InlineObject5';
        $request = $this->getWorkspacesRequest($page, $per_page, $contentType);
