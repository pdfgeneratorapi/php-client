...
/**
    ...
    public function createWorkspaceRequest($create_workspace_request = null, string $contentType = self::contentTypes['createWorkspace'][0])
    {
        ...
        if (isset($create_workspace_request)) {
            if (stripos($headers['Content-Type'], 'application/json') !== false) {
                ...
                $httpBody = \GuzzleHttp\json_encode(ObjectSerializer::sanitizeForSerialization($create_workspace_request));
            } else {
     ...
     */
    public function getWorkspaces(string $contentType = self::contentTypes['getWorkspaces'][0])
    {
        list($response) = $this->getWorkspacesWithHttpInfo($contentType);
        return $response;
    }
     ...
     */
    public function getWorkspacesWithHttpInfo(string $contentType = self::contentTypes['getWorkspaces'][0])
    {
        $request = $this->getWorkspacesRequest($contentType);
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function getWorkspacesAsync(string $contentType = self::contentTypes['getWorkspaces'][0])
    {
        return $this->getWorkspacesAsyncWithHttpInfo($contentType)
            ->then(
                function ($response) {
                    return $response[0];
                }
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function getWorkspacesAsyncWithHttpInfo(string $contentType = self::contentTypes['getWorkspaces'][0])
    {
        $returnType = '\PDFGeneratorAPI\Model\GetWorkspaces200Response';
        $request = $this->getWorkspacesRequest($contentType);
     ...
     * @return \GuzzleHttp\Psr7\Request
     */
    public function getWorkspacesRequest(string $contentType = self::contentTypes['getWorkspaces'][0])
    {
