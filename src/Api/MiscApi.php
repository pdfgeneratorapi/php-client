...
class MiscApi
{
     ...
     * @return \PDFGeneratorAPI\Model\GetStatus200Response
     */
     ...
     * @throws \PDFGeneratorAPI\ApiException on non-2xx response or if the response body is not in the expected format
     * @throws \InvalidArgumentException
     * @return array of \PDFGeneratorAPI\Model\GetStatus200Response, HTTP status code, HTTP response headers (array of strings)
     */
    public function getStatusWithHttpInfo(string $contentType = self::contentTypes['getStatus'][0])
    {
        ...
        try {
            ...
            switch($statusCode) {
                case 200:
                    if ('\PDFGeneratorAPI\Model\GetStatus200Response' === '\SplFileObject') {
                        $content = $response->getBody(); //stream goes to serializer
                    } else {
                        $content = (string) $response->getBody();
                        if ('\PDFGeneratorAPI\Model\GetStatus200Response' !== 'string') {
                            try {
                    ...
                    return [
                        ObjectSerializer::deserialize($content, '\PDFGeneratorAPI\Model\GetStatus200Response', []),
            ...
            $returnType = '\PDFGeneratorAPI\Model\GetStatus200Response';
            ...
            switch ($e->getCode()) {
                case 200:
                    $data = ObjectSerializer::deserialize(
                        $e->getResponseBody(),
                        '\PDFGeneratorAPI\Model\GetStatus200Response',
