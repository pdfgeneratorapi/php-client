...
/**
    ...
    public function generateDocumentRequest($generate_document_request, string $contentType = self::contentTypes['generateDocument'][0])
    {
        ...
        if (isset($generate_document_request)) {
            if (stripos($headers['Content-Type'], 'application/json') !== false) {
                ...
                $httpBody = \GuzzleHttp\json_encode(ObjectSerializer::sanitizeForSerialization($generate_document_request));
            } else {
     ...
     *
     * @param  \PDFGeneratorAPI\Model\GenerateDocumentAsyncRequest $generate_document_async_request Request parameters, including template id, data and formats. (required)
     * @param  string $contentType The value for the Content-Type header. Check self::contentTypes['generateDocumentAsync'] to see the possible values for this operation
     *
     * @throws \PDFGeneratorAPI\ApiException on non-2xx response
     * @throws \InvalidArgumentException
     * @return \PDFGeneratorAPI\Model\GenerateDocumentAsync200Response|\PDFGeneratorAPI\Model\GetTemplates401Response|\PDFGeneratorAPI\Model\GetTemplates402Response|\PDFGeneratorAPI\Model\GetTemplates403Response|\PDFGeneratorAPI\Model\GetTemplates404Response|\PDFGeneratorAPI\Model\GetTemplates422Response|\PDFGeneratorAPI\Model\GetTemplates429Response|\PDFGeneratorAPI\Model\GetTemplates500Response
     */
    public function generateDocumentAsync($generate_document_async_request, string $contentType = self::contentTypes['generateDocumentAsync'][0])
    {
        list($response) = $this->generateDocumentAsyncWithHttpInfo($generate_document_async_request, $contentType);
        return $response;
    }
     ...
     * @throws \PDFGeneratorAPI\ApiException on non-2xx response
     * @throws \InvalidArgumentException
     * @return array of \PDFGeneratorAPI\Model\GenerateDocumentAsync200Response|\PDFGeneratorAPI\Model\GetTemplates401Response|\PDFGeneratorAPI\Model\GetTemplates402Response|\PDFGeneratorAPI\Model\GetTemplates403Response|\PDFGeneratorAPI\Model\GetTemplates404Response|\PDFGeneratorAPI\Model\GetTemplates422Response|\PDFGeneratorAPI\Model\GetTemplates429Response|\PDFGeneratorAPI\Model\GetTemplates500Response, HTTP status code, HTTP response headers (array of strings)
     */
    public function generateDocumentAsyncWithHttpInfo($generate_document_async_request, string $contentType = self::contentTypes['generateDocumentAsync'][0])
    {
        $request = $this->generateDocumentAsyncRequest($generate_document_async_request, $contentType);
        ...
        try {
            ...
            switch($statusCode) {
                case 200:
                    if ('\PDFGeneratorAPI\Model\GenerateDocumentAsync200Response' === '\SplFileObject') {
                        $content = $response->getBody(); //stream goes to serializer
                    } else {
                        $content = (string) $response->getBody();
                        if ('\PDFGeneratorAPI\Model\GenerateDocumentAsync200Response' !== 'string') {
                            $content = json_decode($content);
                        }
                    }

                    return [
                        ObjectSerializer::deserialize($content, '\PDFGeneratorAPI\Model\GenerateDocumentAsync200Response', []),
                        $response->getStatusCode(),
                        $response->getHeaders()
                    ];
                case 401:
            ...
            $returnType = '\PDFGeneratorAPI\Model\GenerateDocumentAsync200Response';
            if ($returnType === '\SplFileObject') {
                $content = $response->getBody(); //stream goes to serializer
            } else {
                $content = (string) $response->getBody();
            ...
            switch ($e->getCode()) {
                case 200:
                    $data = ObjectSerializer::deserialize(
                        $e->getResponseBody(),
                        '\PDFGeneratorAPI\Model\GenerateDocumentAsync200Response',
                        $e->getResponseHeaders()
                    );
                    $e->setResponseObject($data);
                    break;
    ...
    /**
     * Operation generateDocumentAsyncAsync
     *
     * Generate document (async)
     *
     * @param  \PDFGeneratorAPI\Model\GenerateDocumentAsyncRequest $generate_document_async_request Request parameters, including template id, data and formats. (required)
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function generateDocumentAsyncAsync($generate_document_async_request, string $contentType = self::contentTypes['generateDocumentAsync'][0])
    {
        return $this->generateDocumentAsyncAsyncWithHttpInfo($generate_document_async_request, $contentType)
            ->then(
                function ($response) {
                    return $response[0];
                }
    ...
    /**
     * Operation generateDocumentAsyncAsyncWithHttpInfo
     *
     * Generate document (async)
     *
     * @param  \PDFGeneratorAPI\Model\GenerateDocumentAsyncRequest $generate_document_async_request Request parameters, including template id, data and formats. (required)
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function generateDocumentAsyncAsyncWithHttpInfo($generate_document_async_request, string $contentType = self::contentTypes['generateDocumentAsync'][0])
    {
        $returnType = '\PDFGeneratorAPI\Model\GenerateDocumentAsync200Response';
        $request = $this->generateDocumentAsyncRequest($generate_document_async_request, $contentType);
    ...
    /**
     * Create request for operation 'generateDocumentAsync'
     *
     * @param  \PDFGeneratorAPI\Model\GenerateDocumentAsyncRequest $generate_document_async_request Request parameters, including template id, data and formats. (required)
     * @param  string $contentType The value for the Content-Type header. Check self::contentTypes['generateDocumentAsync'] to see the possible values for this operation
     *
     ...
     * @return \GuzzleHttp\Psr7\Request
     */
    public function generateDocumentAsyncRequest($generate_document_async_request, string $contentType = self::contentTypes['generateDocumentAsync'][0])
    {

        // verify the required parameter 'generate_document_async_request' is set
        if ($generate_document_async_request === null || (is_array($generate_document_async_request) && count($generate_document_async_request) === 0)) {
            throw new \InvalidArgumentException(
                'Missing the required parameter $generate_document_async_request when calling generateDocumentAsync'
            );
        }
        ...
        // for model (json/xml)
        if (isset($generate_document_async_request)) {
            if (stripos($headers['Content-Type'], 'application/json') !== false) {
                # if Content-Type contains "application/json", json_encode the body
                $httpBody = \GuzzleHttp\json_encode(ObjectSerializer::sanitizeForSerialization($generate_document_async_request));
            } else {
                $httpBody = $generate_document_async_request;
            }
        } elseif (count($formParams) > 0) {
            if ($multipart) {
                $multipartContents = [];
    ...
    public function generateDocumentBatchRequest($generate_document_batch_request, string $contentType = self::contentTypes['generateDocumentBatch'][0])
    {
        ...
        if (isset($generate_document_batch_request)) {
            if (stripos($headers['Content-Type'], 'application/json') !== false) {
                # if Content-Type contains "application/json", json_encode the body
                $httpBody = \GuzzleHttp\json_encode(ObjectSerializer::sanitizeForSerialization($generate_document_batch_request));
            } else {
     ...
     *
     * @param  \PDFGeneratorAPI\Model\GenerateDocumentBatchAsyncRequest $generate_document_batch_async_request Request parameters, including template id, data and formats. (required)
     * @param  string $contentType The value for the Content-Type header. Check self::contentTypes['generateDocumentBatchAsync'] to see the possible values for this operation
     *
     * @throws \PDFGeneratorAPI\ApiException on non-2xx response
     * @throws \InvalidArgumentException
     * @return \PDFGeneratorAPI\Model\GenerateDocumentAsync200Response|\PDFGeneratorAPI\Model\GetTemplates401Response|\PDFGeneratorAPI\Model\GetTemplates402Response|\PDFGeneratorAPI\Model\GetTemplates403Response|\PDFGeneratorAPI\Model\GetTemplates404Response|\PDFGeneratorAPI\Model\GetTemplates422Response|\PDFGeneratorAPI\Model\GetTemplates429Response|\PDFGeneratorAPI\Model\GetTemplates500Response
     */
    public function generateDocumentBatchAsync($generate_document_batch_async_request, string $contentType = self::contentTypes['generateDocumentBatchAsync'][0])
    {
        list($response) = $this->generateDocumentBatchAsyncWithHttpInfo($generate_document_batch_async_request, $contentType);
        return $response;
    }
     ...
     * @return array of \PDFGeneratorAPI\Model\GenerateDocumentAsync200Response|\PDFGeneratorAPI\Model\GetTemplates401Response|\PDFGeneratorAPI\Model\GetTemplates402Response|\PDFGeneratorAPI\Model\GetTemplates403Response|\PDFGeneratorAPI\Model\GetTemplates404Response|\PDFGeneratorAPI\Model\GetTemplates422Response|\PDFGeneratorAPI\Model\GetTemplates429Response|\PDFGeneratorAPI\Model\GetTemplates500Response, HTTP status code, HTTP response headers (array of strings)
     */
    public function generateDocumentBatchAsyncWithHttpInfo($generate_document_batch_async_request, string $contentType = self::contentTypes['generateDocumentBatchAsync'][0])
    {
        $request = $this->generateDocumentBatchAsyncRequest($generate_document_batch_async_request, $contentType);
    ...
    /**
     * Operation generateDocumentBatchAsyncAsync
     *
     * Generate document (batch + async)
     *
     * @param  \PDFGeneratorAPI\Model\GenerateDocumentBatchAsyncRequest $generate_document_batch_async_request Request parameters, including template id, data and formats. (required)
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function generateDocumentBatchAsyncAsync($generate_document_batch_async_request, string $contentType = self::contentTypes['generateDocumentBatchAsync'][0])
    {
        return $this->generateDocumentBatchAsyncAsyncWithHttpInfo($generate_document_batch_async_request, $contentType)
            ->then(
                function ($response) {
                    return $response[0];
                }
    ...
    /**
     * Operation generateDocumentBatchAsyncAsyncWithHttpInfo
     *
     * Generate document (batch + async)
     *
     * @param  \PDFGeneratorAPI\Model\GenerateDocumentBatchAsyncRequest $generate_document_batch_async_request Request parameters, including template id, data and formats. (required)
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function generateDocumentBatchAsyncAsyncWithHttpInfo($generate_document_batch_async_request, string $contentType = self::contentTypes['generateDocumentBatchAsync'][0])
    {
        $returnType = '\PDFGeneratorAPI\Model\GenerateDocumentAsync200Response';
        $request = $this->generateDocumentBatchAsyncRequest($generate_document_batch_async_request, $contentType);
    ...
    /**
     * Create request for operation 'generateDocumentBatchAsync'
     *
     * @param  \PDFGeneratorAPI\Model\GenerateDocumentBatchAsyncRequest $generate_document_batch_async_request Request parameters, including template id, data and formats. (required)
     * @param  string $contentType The value for the Content-Type header. Check self::contentTypes['generateDocumentBatchAsync'] to see the possible values for this operation
     *
     ...
     * @return \GuzzleHttp\Psr7\Request
     */
    public function generateDocumentBatchAsyncRequest($generate_document_batch_async_request, string $contentType = self::contentTypes['generateDocumentBatchAsync'][0])
    {

        // verify the required parameter 'generate_document_batch_async_request' is set
        if ($generate_document_batch_async_request === null || (is_array($generate_document_batch_async_request) && count($generate_document_batch_async_request) === 0)) {
            throw new \InvalidArgumentException(
                'Missing the required parameter $generate_document_batch_async_request when calling generateDocumentBatchAsync'
            );
        }
        ...
        // for model (json/xml)
        if (isset($generate_document_batch_async_request)) {
            if (stripos($headers['Content-Type'], 'application/json') !== false) {
                # if Content-Type contains "application/json", json_encode the body
                $httpBody = \GuzzleHttp\json_encode(ObjectSerializer::sanitizeForSerialization($generate_document_batch_async_request));
            } else {
                $httpBody = $generate_document_batch_async_request;
            }
        } elseif (count($formParams) > 0) {
            if ($multipart) {
                $multipartContents = [];
     ...
     * Get documents
     *
     * @param  string $start_date Start date. Format: Y-m-d H:i:s (optional)
     * @param  string $end_date End date. Format: Y-m-d H:i:s. Defaults to current timestamp (optional)
     ...
     * @throws \PDFGeneratorAPI\ApiException on non-2xx response
     * @throws \InvalidArgumentException
     * @return \PDFGeneratorAPI\Model\GetDocuments200Response|\PDFGeneratorAPI\Model\GetTemplates401Response|\PDFGeneratorAPI\Model\GetTemplates402Response|\PDFGeneratorAPI\Model\GetTemplates403Response|\PDFGeneratorAPI\Model\GetTemplates404Response|\PDFGeneratorAPI\Model\GetTemplates422Response|\PDFGeneratorAPI\Model\GetTemplates429Response|\PDFGeneratorAPI\Model\GetTemplates500Response
     */
    public function getDocuments($start_date = null, $end_date = null, string $contentType = self::contentTypes['getDocuments'][0])
    {
        list($response) = $this->getDocumentsWithHttpInfo($start_date, $end_date, $contentType);
        return $response;
    }
     ...
     * @throws \PDFGeneratorAPI\ApiException on non-2xx response
     * @throws \InvalidArgumentException
     * @return array of \PDFGeneratorAPI\Model\GetDocuments200Response|\PDFGeneratorAPI\Model\GetTemplates401Response|\PDFGeneratorAPI\Model\GetTemplates402Response|\PDFGeneratorAPI\Model\GetTemplates403Response|\PDFGeneratorAPI\Model\GetTemplates404Response|\PDFGeneratorAPI\Model\GetTemplates422Response|\PDFGeneratorAPI\Model\GetTemplates429Response|\PDFGeneratorAPI\Model\GetTemplates500Response, HTTP status code, HTTP response headers (array of strings)
     */
    public function getDocumentsWithHttpInfo($start_date = null, $end_date = null, string $contentType = self::contentTypes['getDocuments'][0])
    {
        $request = $this->getDocumentsRequest($start_date, $end_date, $contentType);
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function getDocumentsAsync($start_date = null, $end_date = null, string $contentType = self::contentTypes['getDocuments'][0])
    {
        return $this->getDocumentsAsyncWithHttpInfo($start_date, $end_date, $contentType)
            ->then(
                function ($response) {
                    return $response[0];
                }
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function getDocumentsAsyncWithHttpInfo($start_date = null, $end_date = null, string $contentType = self::contentTypes['getDocuments'][0])
    {
        $returnType = '\PDFGeneratorAPI\Model\GetDocuments200Response';
        $request = $this->getDocumentsRequest($start_date, $end_date, $contentType);
     ...
     * @return \GuzzleHttp\Psr7\Request
     */
    public function getDocumentsRequest($start_date = null, $end_date = null, string $contentType = self::contentTypes['getDocuments'][0])
    {
