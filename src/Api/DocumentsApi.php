...
/**
    ...
    public function generateDocumentWithHttpInfo($generate_document_request, string $contentType = self::contentTypes['generateDocument'][0])
    {
        ...
        try {
            ...
            switch($statusCode) {
                case 201:
                    if ('\PDFGeneratorAPI\Model\GenerateDocument201Response' === '\SplFileObject') {
                        $content = $response->getBody(); //stream goes to serializer
                    } else {
                        $content = (string) $response->getBody();
                        if ('\PDFGeneratorAPI\Model\GenerateDocument201Response' !== 'string') {
                            $content = json_decode($content);
                        }
                    }

                    return [
                        ObjectSerializer::deserialize($content, '\PDFGeneratorAPI\Model\GenerateDocument201Response', []),
            ...
            $returnType = '\PDFGeneratorAPI\Model\GenerateDocument201Response';
     ...
     * @throws \PDFGeneratorAPI\ApiException on non-2xx response
     * @throws \InvalidArgumentException
     * @return \PDFGeneratorAPI\Model\GenerateDocumentAsynchronous201Response|\PDFGeneratorAPI\Model\GetTemplates401Response|\PDFGeneratorAPI\Model\GetTemplates402Response|\PDFGeneratorAPI\Model\GetTemplates403Response|\PDFGeneratorAPI\Model\GetTemplates404Response|\PDFGeneratorAPI\Model\GetTemplates422Response|\PDFGeneratorAPI\Model\GetTemplates429Response|\PDFGeneratorAPI\Model\GetTemplates500Response
     */
     ...
     * @throws \PDFGeneratorAPI\ApiException on non-2xx response
     * @throws \InvalidArgumentException
     * @return array of \PDFGeneratorAPI\Model\GenerateDocumentAsynchronous201Response|\PDFGeneratorAPI\Model\GetTemplates401Response|\PDFGeneratorAPI\Model\GetTemplates402Response|\PDFGeneratorAPI\Model\GetTemplates403Response|\PDFGeneratorAPI\Model\GetTemplates404Response|\PDFGeneratorAPI\Model\GetTemplates422Response|\PDFGeneratorAPI\Model\GetTemplates429Response|\PDFGeneratorAPI\Model\GetTemplates500Response, HTTP status code, HTTP response headers (array of strings)
     */
     ...
     */
    public function getDocuments($start_date = null, $end_date = null, $page = 1, $per_page = 15, string $contentType = self::contentTypes['getDocuments'][0])
    {
        list($response) = $this->getDocumentsWithHttpInfo($start_date, $end_date, $page, $per_page, $contentType);
        return $response;
    }
     ...
     */
    public function getDocumentsWithHttpInfo($start_date = null, $end_date = null, $page = 1, $per_page = 15, string $contentType = self::contentTypes['getDocuments'][0])
    {
        $request = $this->getDocumentsRequest($start_date, $end_date, $page, $per_page, $contentType);
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function getDocumentsAsync($start_date = null, $end_date = null, $page = 1, $per_page = 15, string $contentType = self::contentTypes['getDocuments'][0])
    {
        return $this->getDocumentsAsyncWithHttpInfo($start_date, $end_date, $page, $per_page, $contentType)
            ->then(
                function ($response) {
                    return $response[0];
                }
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function getDocumentsAsyncWithHttpInfo($start_date = null, $end_date = null, $page = 1, $per_page = 15, string $contentType = self::contentTypes['getDocuments'][0])
    {
        $returnType = '\PDFGeneratorAPI\Model\GetDocuments200Response';
        $request = $this->getDocumentsRequest($start_date, $end_date, $page, $per_page, $contentType);
     ...
     * @return \GuzzleHttp\Psr7\Request
     */
    public function getDocumentsRequest($start_date = null, $end_date = null, $page = 1, $per_page = 15, string $contentType = self::contentTypes['getDocuments'][0])
    {
