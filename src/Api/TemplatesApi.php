...
/**
     ...
     */
    public function getTemplates($name = null, $tags = null, $access = '', string $contentType = self::contentTypes['getTemplates'][0])
    {
        list($response) = $this->getTemplatesWithHttpInfo($name, $tags, $access, $contentType);
        return $response;
    }
     ...
     */
    public function getTemplatesWithHttpInfo($name = null, $tags = null, $access = '', string $contentType = self::contentTypes['getTemplates'][0])
    {
        $request = $this->getTemplatesRequest($name, $tags, $access, $contentType);
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function getTemplatesAsync($name = null, $tags = null, $access = '', string $contentType = self::contentTypes['getTemplates'][0])
    {
        return $this->getTemplatesAsyncWithHttpInfo($name, $tags, $access, $contentType)
            ->then(
                function ($response) {
                    return $response[0];
                }
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function getTemplatesAsyncWithHttpInfo($name = null, $tags = null, $access = '', string $contentType = self::contentTypes['getTemplates'][0])
    {
        $returnType = '\PDFGeneratorAPI\Model\GetTemplates200Response';
        $request = $this->getTemplatesRequest($name, $tags, $access, $contentType);
     ...
     * @return \GuzzleHttp\Psr7\Request
     */
    public function getTemplatesRequest($name = null, $tags = null, $access = '', string $contentType = self::contentTypes['getTemplates'][0])
    {
    ...
    public function openEditorRequest($template_id, $open_editor_request, string $contentType = self::contentTypes['openEditor'][0])
    {
        ...
        if (isset($open_editor_request)) {
            if (stripos($headers['Content-Type'], 'application/json') !== false) {
                # if Content-Type contains "application/json", json_encode the body
                $httpBody = \GuzzleHttp\json_encode(ObjectSerializer::sanitizeForSerialization($open_editor_request));
            } else {
