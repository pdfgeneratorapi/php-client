...
class ConversionApi
{
    ...
    /**
     * Operation convertPDF2Image
     *
     * PDF to Image
     *
     * @param  \PDFGeneratorAPI\Model\ConvertPDF2ImageRequest $convert_pdf2_image_request convert_pdf2_image_request (required)
     * @param  string $contentType The value for the Content-Type header. Check self::contentTypes['convertPDF2Image'] to see the possible values for this operation
     *
     * @throws \PDFGeneratorAPI\ApiException on non-2xx response or if the response body is not in the expected format
     * @throws \InvalidArgumentException
     * @return \PDFGeneratorAPI\Model\InlineObject10|\PDFGeneratorAPI\Model\InlineObject24|\PDFGeneratorAPI\Model\InlineObject25|\PDFGeneratorAPI\Model\InlineObject26|\PDFGeneratorAPI\Model\InlineObject27|\PDFGeneratorAPI\Model\InlineObject29|\PDFGeneratorAPI\Model\InlineObject30|\PDFGeneratorAPI\Model\InlineObject31
     */
    public function convertPDF2Image($convert_pdf2_image_request, string $contentType = self::contentTypes['convertPDF2Image'][0])
    {
        list($response) = $this->convertPDF2ImageWithHttpInfo($convert_pdf2_image_request, $contentType);
        return $response;
    }

    /**
     * Operation convertPDF2ImageWithHttpInfo
     *
     * PDF to Image
     *
     * @param  \PDFGeneratorAPI\Model\ConvertPDF2ImageRequest $convert_pdf2_image_request (required)
     * @param  string $contentType The value for the Content-Type header. Check self::contentTypes['convertPDF2Image'] to see the possible values for this operation
     *
     * @throws \PDFGeneratorAPI\ApiException on non-2xx response or if the response body is not in the expected format
     * @throws \InvalidArgumentException
     * @return array of \PDFGeneratorAPI\Model\InlineObject10|\PDFGeneratorAPI\Model\InlineObject24|\PDFGeneratorAPI\Model\InlineObject25|\PDFGeneratorAPI\Model\InlineObject26|\PDFGeneratorAPI\Model\InlineObject27|\PDFGeneratorAPI\Model\InlineObject29|\PDFGeneratorAPI\Model\InlineObject30|\PDFGeneratorAPI\Model\InlineObject31, HTTP status code, HTTP response headers (array of strings)
     */
    public function convertPDF2ImageWithHttpInfo($convert_pdf2_image_request, string $contentType = self::contentTypes['convertPDF2Image'][0])
    {
        $request = $this->convertPDF2ImageRequest($convert_pdf2_image_request, $contentType);
        ...
        try {
            ...
            switch($statusCode) {
                case 201:
                    return $this->handleResponseWithDataType(
                        '\PDFGeneratorAPI\Model\InlineObject10',
                        $request,
                        $response,
                    );
                case 401:
    ...
    /**
     * Operation convertPDF2ImageAsync
     *
     * PDF to Image
     *
     * @param  \PDFGeneratorAPI\Model\ConvertPDF2ImageRequest $convert_pdf2_image_request (required)
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function convertPDF2ImageAsync($convert_pdf2_image_request, string $contentType = self::contentTypes['convertPDF2Image'][0])
    {
        return $this->convertPDF2ImageAsyncWithHttpInfo($convert_pdf2_image_request, $contentType)
            ->then(
                function ($response) {
                    return $response[0];
                }
    ...
    /**
     * Operation convertPDF2ImageAsyncWithHttpInfo
     *
     * PDF to Image
     *
     * @param  \PDFGeneratorAPI\Model\ConvertPDF2ImageRequest $convert_pdf2_image_request (required)
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function convertPDF2ImageAsyncWithHttpInfo($convert_pdf2_image_request, string $contentType = self::contentTypes['convertPDF2Image'][0])
    {
        $returnType = '\PDFGeneratorAPI\Model\InlineObject10';
        $request = $this->convertPDF2ImageRequest($convert_pdf2_image_request, $contentType);
    ...
    /**
     * Create request for operation 'convertPDF2Image'
     *
     * @param  \PDFGeneratorAPI\Model\ConvertPDF2ImageRequest $convert_pdf2_image_request (required)
     * @param  string $contentType The value for the Content-Type header. Check self::contentTypes['convertPDF2Image'] to see the possible values for this operation
     *
     ...
     * @return \GuzzleHttp\Psr7\Request
     */
    public function convertPDF2ImageRequest($convert_pdf2_image_request, string $contentType = self::contentTypes['convertPDF2Image'][0])
    {

        // verify the required parameter 'convert_pdf2_image_request' is set
        if ($convert_pdf2_image_request === null || (is_array($convert_pdf2_image_request) && count($convert_pdf2_image_request) === 0)) {
            throw new \InvalidArgumentException(
                'Missing the required parameter $convert_pdf2_image_request when calling convertPDF2Image'
            );
        }


        $resourcePath = '/conversion/pdf2image';
        $formParams = [];
        $queryParams = [];
        $headerParams = [];
        $httpBody = '';
        ...
        // for model (json/xml)
        if (isset($convert_pdf2_image_request)) {
            if (stripos($headers['Content-Type'], 'application/json') !== false) {
                # if Content-Type contains "application/json", json_encode the body
                $httpBody = \GuzzleHttp\Utils::jsonEncode(ObjectSerializer::sanitizeForSerialization($convert_pdf2_image_request));
            } else {
                $httpBody = $convert_pdf2_image_request;
            }
        } elseif (count($formParams) > 0) {
            if ($multipart) {
                $multipartContents = [];
