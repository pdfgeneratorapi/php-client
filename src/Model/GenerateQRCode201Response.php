...
/**
 * GenerateQRCode201Response Class Doc Comment
 *
 * @category Class
 * @package  PDFGeneratorAPI
 * @author   OpenAPI Generator team
 ...
 */
class GenerateQRCode201Response implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'generateQRCode_201_response';
    ...
    protected static $openAPITypes = [
        'response' => 'string',
        'meta' => '\PDFGeneratorAPI\Model\GenerateQRCode201ResponseMeta'
    ];
    ...
    */
     ...
     * Sets response
     *
     * @param string|null $response Base64 encoded image if the output=base64. Raw image string if output=file is used
     *
     * @return self
     */
     ...
     * Gets meta
     *
     * @return \PDFGeneratorAPI\Model\GenerateQRCode201ResponseMeta|null
     */
     ...
     * Sets meta
     *
     * @param \PDFGeneratorAPI\Model\GenerateQRCode201ResponseMeta|null $meta meta
     *
     * @return self
     */
