...
class InlineResponse2001 implements ModelInterface, ArrayAccess
{
    ...
    protected static $openAPITypes = [
        'response' => '\PDFGeneratorAPI\Model\TemplateDefinition'
    ];
     ...
     * Gets response
     *
     * @return \PDFGeneratorAPI\Model\TemplateDefinition|null
     */
     ...
     * Sets response
     *
     * @param \PDFGeneratorAPI\Model\TemplateDefinition|null $response response
     *
     * @return $this
     */
