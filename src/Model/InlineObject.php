...
class InlineObject implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    protected static $openAPITypes = [
        'response' => 'string',
        'meta' => '\PDFGeneratorAPI\Model\InlineObjectMeta'
    ];
    ...
    */
     ...
     * Sets response
     *
     * @param string|null $response Base64 encoded XML document if the output=base64 is used.
     *
     * @return self
     */
     ...
     * Gets meta
     *
     * @return \PDFGeneratorAPI\Model\InlineObjectMeta|null
     */
     ...
     * Sets meta
     *
     * @param \PDFGeneratorAPI\Model\InlineObjectMeta|null $meta meta
     *
     * @return self
     */
