...
class InlineObject implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    protected static $openAPITypes = [
        'response' => '\PDFGeneratorAPI\Model\InlineObjectResponse'
    ];
    ...
    */
     ...
     * Gets response
     *
     * @return \PDFGeneratorAPI\Model\InlineObjectResponse|null
     */
     ...
     * Sets response
     *
     * @param \PDFGeneratorAPI\Model\InlineObjectResponse|null $response response
     *
     * @return self
     */
