...
/**
 * FormActionSendSendDocumentHeadersInner Class Doc Comment
 *
 * @category Class
 * @package  PDFGeneratorAPI
 * @author   OpenAPI Generator team
 ...
 */
class FormActionSendSendDocumentHeadersInner implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'formActionSend_send_document_headers_inner';
    ...
    */
    ...
    public function setName($name)
    {
        ...
        if ((mb_strlen($name) > 255)) {
            throw new \InvalidArgumentException('invalid length for $name when calling FormActionSendSendDocumentHeadersInner., must be smaller than or equal to 255.');
        }
    ...
    public function setValue($value)
    {
        ...
        if ((mb_strlen($value) > 255)) {
            throw new \InvalidArgumentException('invalid length for $value when calling FormActionSendSendDocumentHeadersInner., must be smaller than or equal to 255.');
        }
