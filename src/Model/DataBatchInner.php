...
/**
 * DataBatchInner Class Doc Comment
 *
 * @category Class
 * @package  PDFGeneratorAPI
 * @author   OpenAPI Generator team
 ...
 */
class DataBatchInner implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'DataBatch_inner';
    ...
    */
     ...
     * Sets template
     *
     * @param int|null $template Template id
     *
     * @return self
     */
     ...
     * Sets data
     *
     * @param object|null $data JSON data used to replace data fields in the template
     *
     * @return self
     */
