...
/**
 * TemplateDefinitionNewPagesInner Class Doc Comment
 *
 * @category Class
 * @package  PDFGeneratorAPI
 * @author   OpenAPI Generator team
 ...
 */
class TemplateDefinitionNewPagesInner implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'TemplateDefinitionNew_pages_inner';
    ...
    protected static $openAPITypes = [
        'width' => 'float',
        'height' => 'float',
        'margins' => '\PDFGeneratorAPI\Model\TemplateDefinitionNewPagesInnerMargins',
        'border' => 'bool',
        'components' => 'object[]',
        'layout' => 'object',
    ...
    protected static $setters = [
        ...
        'layout' => 'setLayout',
        'conditional_formats' => 'setConditionalFormats',
    ...
    protected static $getters = [
        ...
        'layout' => 'getLayout',
        'conditional_formats' => 'getConditionalFormats',
    ...
    public function __construct(?array $data = null)
    {
        ...
        $this->setIfExists('border', $data ?? [], false);
        $this->setIfExists('components', $data ?? [], null);
        $this->setIfExists('layout', $data ?? [], null);
        $this->setIfExists('conditional_formats', $data ?? [], null);
    ...
    */
     ...
     * Gets margins
     *
     * @return \PDFGeneratorAPI\Model\TemplateDefinitionNewPagesInnerMargins|null
     */
     ...
     * Sets margins
     *
     * @param \PDFGeneratorAPI\Model\TemplateDefinitionNewPagesInnerMargins|null $margins margins
     *
     * @return self
     */
     ...
     * Sets layout
     *
     * @param object|null $layout Defines page specific layout which can differ from the main template layout (e.g page format, margins).
     *
     * @return self
     */
    ...
    /**
     * Gets conditional_formats
     *
     * @return object[]|null
     */
    public function getConditionalFormats()
    {
        return $this->container['conditional_formats'];
    }

    /**
     * Sets conditional_formats
     *
     * @param object[]|null $conditional_formats conditional_formats
     *
     * @return self
     */
    public function setConditionalFormats($conditional_formats)
    {
        if (is_null($conditional_formats)) {
            throw new \InvalidArgumentException('non-nullable conditional_formats cannot be null');
        }
        $this->container['conditional_formats'] = $conditional_formats;
     ...
     *
     * @param string|null $background_image Defines background image for the page.
     *
     * @return self
     */
