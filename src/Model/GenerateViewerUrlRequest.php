...
/**
 * GenerateViewerUrlRequest Class Doc Comment
 *
 * @category Class
 * @package  PDFGeneratorAPI
 * @author   OpenAPI Generator team
 ...
 */
class GenerateViewerUrlRequest implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'generateViewerUrl_request';
    ...
    */
     ...
     * Sets output
     *
     * @param string|null $output Response format. `url` returns a public URL to the stored document; `viewer` returns a public URL to the PDF viewer (with encrypted prefill when provided).
     *
     * @return self
     */
