...
/**
 * FormConfiguration Class Doc Comment
 *
 * @category Class
 * @description Optional display configuration shown around the form fields in the embeddable Form Builder and in the shared data collection form.
 * @package  PDFGeneratorAPI
 * @author   OpenAPI Generator team
 * @link     https://openapi-generator.tech
 * @implements \ArrayAccess<string, mixed>
 */
class FormConfiguration implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'formConfiguration';
    ...
    public function __construct(?array $data = null)
    {
        ...
        $this->setIfExists('outro', $data ?? [], null);
    }
    ...
    */
    ...
    public function listInvalidProperties()
    {
        ...
        if (!is_null($this->container['intro']) && (mb_strlen($this->container['intro']) > 1275)) {
            $invalidProperties[] = "invalid value for 'intro', the character length must be smaller than or equal to 1275.";
        }

        if (!is_null($this->container['outro']) && (mb_strlen($this->container['outro']) > 1275)) {
            $invalidProperties[] = "invalid value for 'outro', the character length must be smaller than or equal to 1275.";
        }
     ...
     * Sets title
     *
     * @param string|null $title Form title displayed above the form
     *
     * @return self
     */
    public function setTitle($title)
    {
        ...
        if (!is_null($title) && (mb_strlen($title) > 255)) {
            throw new \InvalidArgumentException('invalid length for $title when calling FormConfiguration., must be smaller than or equal to 255.');
        }
     ...
     * Sets intro
     *
     * @param string|null $intro Introductory text displayed above the form fields. Supports rich text.
     *
     * @return self
     */
    ...
    {
        if (is_null($intro)) {
            array_push($this->openAPINullablesSetToNull, 'intro');
        } else {
            $nullablesSetToNull = $this->getOpenAPINullablesSetToNull();
            $index = array_search('intro', $nullablesSetToNull);
            if ($index !== FALSE) {
                unset($nullablesSetToNull[$index]);
                $this->setOpenAPINullablesSetToNull($nullablesSetToNull);
            }
        }
        if (!is_null($intro) && (mb_strlen($intro) > 1275)) {
            throw new \InvalidArgumentException('invalid length for $intro when calling FormConfiguration., must be smaller than or equal to 1275.');
        }
    ...
    {
        return $this->container['outro'];
    }

    /**
     * Sets outro
     *
     * @param string|null $outro Closing text displayed below the form fields. Supports rich text.
     *
     * @return self
     */
    ...
    {
        if (is_null($outro)) {
            array_push($this->openAPINullablesSetToNull, 'outro');
        } else {
            $nullablesSetToNull = $this->getOpenAPINullablesSetToNull();
            $index = array_search('outro', $nullablesSetToNull);
            if ($index !== FALSE) {
                unset($nullablesSetToNull[$index]);
                $this->setOpenAPINullablesSetToNull($nullablesSetToNull);
            }
        }
        if (!is_null($outro) && (mb_strlen($outro) > 1275)) {
            throw new \InvalidArgumentException('invalid length for $outro when calling FormConfiguration., must be smaller than or equal to 1275.');
        }

        $this->container['outro'] = $outro;
