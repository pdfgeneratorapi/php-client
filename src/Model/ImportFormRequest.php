...
/**
 * ImportFormRequest Class Doc Comment
 *
 * @category Class
 * @package  PDFGeneratorAPI
 * @author   OpenAPI Generator team
 ...
 */
class ImportFormRequest implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'importForm_request';
    ...
    protected static $openAPITypes = [
        'file_url' => 'string',
        'form' => '\PDFGeneratorAPI\Model\FormConfigurationNew',
        'file_base64' => 'string'
    ];
    ...
    */
     ...
     * Gets form
     *
     * @return \PDFGeneratorAPI\Model\FormConfigurationNew|null
     */
     ...
     * Sets form
     *
     * @param \PDFGeneratorAPI\Model\FormConfigurationNew|null $form form
     *
     * @return self
     */
