...
/**
 * GetTemplates422Response Class Doc Comment
 *
 * @category Class
 * @package  PDFGeneratorAPI
 * @author   OpenAPI Generator team
 ...
 */
class GetTemplates422Response implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'getTemplates_422_response';
    ...
    public const ERROR_UNABLE_TO_PARSE_JSON_PLEASE_CHECK_FORMATTING = 'Unable to parse JSON, please check formatting';
    public const ERROR_REQUIRED_PARAMETER_MISSING = 'Required parameter missing';
    public const ERROR_REQUIRED_PARAMETER_MISSING__TEMPLATE_DEFINITION_NOT_DEFINED = 'Required parameter missing: template definition not defined';
    public const ERROR_REQUIRED_PARAMETER_MISSING__TEMPLATE_NOT_DEFINED = 'Required parameter missing: template not defined';
    ...
    public function getErrorAllowableValues()
    {
        return [
            ...
            self::ERROR_REQUIRED_PARAMETER_MISSING__TEMPLATE_DEFINITION_NOT_DEFINED,
            self::ERROR_REQUIRED_PARAMETER_MISSING__TEMPLATE_NOT_DEFINED,
        ];
    }
