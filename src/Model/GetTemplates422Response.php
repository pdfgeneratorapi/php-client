...
class GetTemplates422Response implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    public const ERROR_REQUIRED_PARAMETER_MISSING_TEMPLATE_DEFINITION_NOT_DEFINED = 'Required parameter missing: template definition not defined';
    public const ERROR_REQUIRED_PARAMETER_MISSING_TEMPLATE_NOT_DEFINED = 'Required parameter missing: template not defined';
