...
/**
 * ConvertPDF2ImageRequest Class Doc Comment
 *
 * @category Class
 * @package  PDFGeneratorAPI
 * @author   OpenAPI Generator team
 ...
 */
class ConvertPDF2ImageRequest implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'convertPDF2Image_request';
    ...
    public function __construct(?array $data = null)
    {
        ...
        $this->setIfExists('resolution', $data ?? [], 150);
        $this->setIfExists('pages', $data ?? [], 'all');
        $this->setIfExists('output', $data ?? [], 'base64');
    ...
    */
    ...
    public function listInvalidProperties()
    {
        ...
        if (!is_null($this->container['resolution']) && ($this->container['resolution'] > 600)) {
            $invalidProperties[] = "invalid value for 'resolution', must be smaller than or equal to 600.";
        }

        if (!is_null($this->container['resolution']) && ($this->container['resolution'] < 72)) {
            $invalidProperties[] = "invalid value for 'resolution', must be bigger than or equal to 72.";
        }
     ...
     * Sets file_base64
     *
     * @param string|null $file_base64 Base64 encoded PDF file. Required if file_url is not provided.
     *
     * @return self
     */
     ...
     * Sets file_url
     *
     * @param string|null $file_url Public HTTPS URL to a PDF file. Required if file_base64 is not provided.
     *
     * @return self
     */
     ...
     * Sets format
     *
     * @param string|null $format Output image format
     *
     * @return self
     */
     ...
     * Sets quality
     *
     * @param int|null $quality Image quality (1-100)
     *
     * @return self
     */
    public function setQuality($quality)
    {
        ...
        if (($quality > 100)) {
            throw new \InvalidArgumentException('invalid value for $quality when calling ConvertPDF2ImageRequest., must be smaller than or equal to 100.');
        }
        if (($quality < 1)) {
            throw new \InvalidArgumentException('invalid value for $quality when calling ConvertPDF2ImageRequest., must be bigger than or equal to 1.');
        }
     ...
     * Sets resolution
     *
     * @param int|null $resolution Image resolution in DPI (72-600)
     *
     * @return self
     */
    public function setResolution($resolution)
    {
        ...
        if (($resolution > 600)) {
            throw new \InvalidArgumentException('invalid value for $resolution when calling ConvertPDF2ImageRequest., must be smaller than or equal to 600.');
        }
        if (($resolution < 72)) {
            throw new \InvalidArgumentException('invalid value for $resolution when calling ConvertPDF2ImageRequest., must be bigger than or equal to 72.');
        }
     ...
     * Sets pages
     *
     * @param string|null $pages Page number or range to convert. Use a single number (e.g. \"1\") or a range (e.g. \"1-4\"). Defaults to all pages.
     *
     * @return self
     */
     ...
     * Sets output
     *
     * @param string|null $output Output format
     *
     * @return self
     */
    public function setOutput($output)
    {
        ...
        $allowedValues = $this->getOutputAllowableValues();
        if (!in_array($output, $allowedValues, true)) {
            throw new \InvalidArgumentException(
                sprintf(
                    "Invalid value '%s' for 'output', must be one of '%s'",
                    $output,
     ...
     * Sets name
     *
     * @param string|null $name Document name (max 120 characters). Auto-generated if not provided.
     *
     * @return self
     */
    public function setName($name)
    {
        ...
        if ((mb_strlen($name) > 120)) {
            throw new \InvalidArgumentException('invalid length for $name when calling ConvertPDF2ImageRequest., must be smaller than or equal to 120.');
        }
