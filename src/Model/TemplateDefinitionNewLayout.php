...
class TemplateDefinitionNewLayout implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    {
        $this->setIfExists('format', $data ?? [], 'A4');
        $this->setIfExists('width', $data ?? [], null);
        $this->setIfExists('height', $data ?? [], null);
        $this->setIfExists('unit', $data ?? [], 'cm');
        ...
        $this->setIfExists('empty_labels', $data ?? [], 0);
    }
    ...
    */
     ...
     * Sets empty_labels
     *
     * @param int|null $empty_labels Specifies how many blank lables to add to sheet label.
     *
     * @return self
     */
