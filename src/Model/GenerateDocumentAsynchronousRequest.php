...
/**
 * GenerateDocumentAsynchronousRequest Class Doc Comment
 *
 * @category Class
 * @package  PDFGeneratorAPI
 * @author   OpenAPI Generator team
 ...
 */
class GenerateDocumentAsynchronousRequest implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'generateDocumentAsynchronous_request';
    ...
    protected static $openAPITypes = [
        'template' => '\PDFGeneratorAPI\Model\TemplateParam',
        'callback' => '\PDFGeneratorAPI\Model\CallbackParam',
        'format' => '\PDFGeneratorAPI\Model\FormatParam',
        'output' => '\PDFGeneratorAPI\Model\AsyncOutputParam',
        'name' => 'string',
        'testing' => 'bool',
        'make_accessible' => 'bool',
        'metadata' => '\PDFGeneratorAPI\Model\MetadataParam'
    ];
    ...
    protected static $setters = [
        ...
        'name' => 'setName',
        'testing' => 'setTesting',
        'make_accessible' => 'setMakeAccessible',
    ...
    protected static $getters = [
        ...
        'name' => 'getName',
        'testing' => 'getTesting',
        'make_accessible' => 'getMakeAccessible',
    ...
    public function __construct(?array $data = null)
    {
        ...
        $this->setIfExists('testing', $data ?? [], false);
        $this->setIfExists('make_accessible', $data ?? [], false);
    ...
    */
     ...
     * Gets template
     *
     * @return \PDFGeneratorAPI\Model\TemplateParam|null
     */
     ...
     * Sets template
     *
     * @param \PDFGeneratorAPI\Model\TemplateParam|null $template template
     *
     * @return self
     */
     ...
     * Gets callback
     *
     * @return \PDFGeneratorAPI\Model\CallbackParam|null
     */
     ...
     * Sets callback
     *
     * @param \PDFGeneratorAPI\Model\CallbackParam|null $callback callback
     *
     * @return self
     */
     ...
     * Gets format
     *
     * @return \PDFGeneratorAPI\Model\FormatParam|null
     */
     ...
     * Sets format
     *
     * @param \PDFGeneratorAPI\Model\FormatParam|null $format format
     *
     * @return self
     */
     ...
     * Gets output
     *
     * @return \PDFGeneratorAPI\Model\AsyncOutputParam|null
     */
     ...
     * Sets output
     *
     * @param \PDFGeneratorAPI\Model\AsyncOutputParam|null $output output
     *
     * @return self
     */
     ...
     * Sets name
     *
     * @param string|null $name Generated document name (optional)
     *
     * @return self
     */
     ...
     * Sets testing
     *
     * @param bool|null $testing When set to true the generation is not counted as merge (monthly usage), but a large PREVIEW stamp is added.
     *
     * @return self
     */
    ...
    /**
     * Gets make_accessible
     *
     * @return bool|null
     */
    public function getMakeAccessible()
    {
        return $this->container['make_accessible'];
    }

    /**
     * Sets make_accessible
     *
     * @param bool|null $make_accessible Enables semantic document tagging. When enabled, a separate Make Accessible action is executed, which consumes additional credits.
     *
     * @return self
     */
    public function setMakeAccessible($make_accessible)
    {
        if (is_null($make_accessible)) {
            throw new \InvalidArgumentException('non-nullable make_accessible cannot be null');
        }
        $this->container['make_accessible'] = $make_accessible;
     ...
     * Gets metadata
     *
     * @return \PDFGeneratorAPI\Model\MetadataParam|null
     */
     ...
     * Sets metadata
     *
     * @param \PDFGeneratorAPI\Model\MetadataParam|null $metadata metadata
     *
     * @return self
     */
