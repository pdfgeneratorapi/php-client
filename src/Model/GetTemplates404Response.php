...
/**
 * GetTemplates404Response Class Doc Comment
 *
 * @category Class
 * @package  PDFGeneratorAPI
 * @author   OpenAPI Generator team
 ...
 */
class GetTemplates404Response implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'getTemplates_404_response';
    ...
    public const MESSAGE_TEMPLATE_NOT_FOUND = 'Template not found';
    public const MESSAGE_RESOURCE_NOT_FOUND = 'Resource not found';
    public const MESSAGE_NONE_OF_THE_TEMPLATES_IS_AVAILABLE_FOR_THE_WORKSPACE = 'None of the templates is available for the workspace.';
    ...
    public function getMessageAllowableValues()
    {
        return [
            ...
            self::MESSAGE_TEMPLATE_NOT_FOUND,
            self::MESSAGE_RESOURCE_NOT_FOUND,
            self::MESSAGE_NONE_OF_THE_TEMPLATES_IS_AVAILABLE_FOR_THE_WORKSPACE,
        ];
    }
