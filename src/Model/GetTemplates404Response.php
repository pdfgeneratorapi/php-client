...
class GetTemplates404Response implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    public const ERROR_ENTITY_NOT_FOUND = 'Entity not found';
    public const ERROR_RESOURCE_NOT_FOUND = 'Resource not found';
    public const ERROR_NONE_OF_THE_TEMPLATES_IS_AVAILABLE_FOR_THE_WORKSPACE = 'None of the templates is available for the workspace.';
    ...
    public function getErrorAllowableValues()
    {
        return [
            ...
            self::ERROR_NONE_OF_THE_TEMPLATES_IS_AVAILABLE_FOR_THE_WORKSPACE,
        ];
    }
