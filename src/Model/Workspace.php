...
class Workspace implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    protected static $setters = [
        ...
        'is_master_workspace' => 'setIsMasterWorkspace',
    ...
    protected static $getters = [
        ...
        'is_master_workspace' => 'getIsMasterWorkspace',
    ...
    public function __construct(array $data = null)
    {
        ...
        $this->setIfExists('is_master_workspace', $data ?? [], null);
    ...
    */
     ...
     * Sets id
     *
     * @param int|null $id Internal workspace id
     *
     * @return self
     */
     ...
     * Sets identifier
     *
     * @param string|null $identifier The unique workspace idenfitifer specified by your application
     *
     * @return self
     */
    ...
    /**
     * Gets is_master_workspace
     *
     * @return bool|null
     */
    public function getIsMasterWorkspace()
    {
        return $this->container['is_master_workspace'];
    }

    /**
     * Sets is_master_workspace
     *
     * @param bool|null $is_master_workspace True if a master workspace
     *
     * @return self
     */
    public function setIsMasterWorkspace($is_master_workspace)
    {
        if (is_null($is_master_workspace)) {
            throw new \InvalidArgumentException('non-nullable is_master_workspace cannot be null');
        }
        $this->container['is_master_workspace'] = $is_master_workspace;
