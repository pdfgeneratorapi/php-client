...
/**
 * GenerateQRCodeRequest Class Doc Comment
 *
 * @category Class
 * @package  PDFGeneratorAPI
 * @author   OpenAPI Generator team
 ...
 */
class GenerateQRCodeRequest implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'generateQRCode_request';
    ...
    public function __construct(?array $data = null)
    {
        ...
        $this->setIfExists('logo_base64', $data ?? [], null);
    ...
    */
     ...
     * Sets content
     *
     * @param string $content The content which is used to generate QR code
     *
     * @return self
     */
     ...
     * Sets color
     *
     * @param string|null $color QR code in hexadecimal format
     *
     * @return self
     */
     ...
     * Sets logo_base64
     *
     * @param string|null $logo_base64 A logo as a base64 image string to add on the QR code
     *
     * @return self
     */
    public function setLogoBase64($logo_base64)
    {
        if (is_null($logo_base64)) {
            throw new \InvalidArgumentException('non-nullable logo_base64 cannot be null');
        }
     ...
     * Sets logo_url
     *
     * @param string|null $logo_url A logo URL to an image to add on the QR code
     *
     * @return self
     */
     ...
     * Sets output
     *
     * @param string|null $output Response format
     *
     * @return self
     */
