...
/**
 * MetadataParam Class Doc Comment
 *
 * @category Class
 * @description Metadata object (optional)
 * @package  PDFGeneratorAPI
 * @author   OpenAPI Generator team
 * @link     https://openapi-generator.tech
 * @implements \ArrayAccess<string, mixed>
 */
class MetadataParam implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'metadataParam';
    ...
    {
        $this->setIfExists('author', $data ?? [], 'Organization name');
    ...
    */
     ...
     * Sets author
     *
     * @param string|null $author Document author
     *
     * @return self
     */
     ...
     * Sets language
     *
     * @param string|null $language Document language
     *
     * @return self
     */
