...
class GetTemplates401Response implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    public const MESSAGE_FAILED_REQUEST_EXPIRED = 'Authentication failed: request expired';
    public const MESSAGE_FAILED_SIGNATURE_OR_SECRET_MISSING = 'Authentication failed: signature or secret missing';
    public const MESSAGE_FAILED_WORKSPACE_MISSING = 'Authentication failed: workspace missing';
    public const MESSAGE_FAILED_KEY_MISSING = 'Authentication failed: key missing';
    public const MESSAGE_FAILED_PROPERTY_ISS__ISSUER_MISSING_IN_JWT = 'Authentication failed: property iss (issuer) missing in JWT';
    public const MESSAGE_FAILED_PROPERTY_SUB__SUBJECT_MISSING_IN_JWT = 'Authentication failed: property sub (subject) missing in JWT';
    public const MESSAGE_FAILED_PROPERTY_EXP__EXPIRATION_TIME_MISSING_IN_JWT = 'Authentication failed: property exp (expiration time) missing in JWT';
    public const MESSAGE_FAILED_INVALID_ISS__ISSUER = 'Authentication failed: invalid iss (issuer)';
    public const MESSAGE_FAILED_INCORRECT_SIGNATURE = 'Authentication failed: incorrect signature';
    public const MESSAGE_FAILED = 'Authentication failed';
    ...
    {
        return [
            self::MESSAGE_FAILED_REQUEST_EXPIRED,
            self::MESSAGE_FAILED_SIGNATURE_OR_SECRET_MISSING,
            self::MESSAGE_FAILED_WORKSPACE_MISSING,
            self::MESSAGE_FAILED_KEY_MISSING,
            self::MESSAGE_FAILED_PROPERTY_ISS__ISSUER_MISSING_IN_JWT,
            self::MESSAGE_FAILED_PROPERTY_SUB__SUBJECT_MISSING_IN_JWT,
            self::MESSAGE_FAILED_PROPERTY_EXP__EXPIRATION_TIME_MISSING_IN_JWT,
            self::MESSAGE_FAILED_INVALID_ISS__ISSUER,
            self::MESSAGE_FAILED_INCORRECT_SIGNATURE,
            self::MESSAGE_FAILED,
        ];
    }
