...
class GetTemplates401Response implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    public const ERROR_FAILED_REQUEST_EXPIRED = 'Authentication failed: request expired';
    public const ERROR_FAILED_SIGNATURE_OR_SECRET_MISSING = 'Authentication failed: signature or secret missing';
    public const ERROR_FAILED_WORKSPACE_MISSING = 'Authentication failed: workspace missing';
    public const ERROR_FAILED_KEY_MISSING = 'Authentication failed: key missing';
    public const ERROR_FAILED_PROPERTY_ISS__ISSUER_MISSING_IN_JWT = 'Authentication failed: property iss (issuer) missing in JWT';
    public const ERROR_FAILED_PROPERTY_SUB__SUBJECT_MISSING_IN_JWT = 'Authentication failed: property sub (subject) missing in JWT';
    public const ERROR_FAILED_PROPERTY_EXP__EXPIRATION_TIME_MISSING_IN_JWT = 'Authentication failed: property exp (expiration time) missing in JWT';
    public const ERROR_FAILED_INVALID_ISS__ISSUER = 'Authentication failed: invalid iss (issuer)';
    public const ERROR_FAILED_INCORRECT_SIGNATURE = 'Authentication failed: incorrect signature';
    public const ERROR_FAILED = 'Authentication failed';
