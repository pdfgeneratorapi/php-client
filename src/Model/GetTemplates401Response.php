...
/**
 * GetTemplates401Response Class Doc Comment
 *
 * @category Class
 * @package  PDFGeneratorAPI
 * @author   OpenAPI Generator team
 ...
 */
class GetTemplates401Response implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'getTemplates_401_response';
    ...
    public const ERROR_AUTHENTICATION_FAILED__REQUEST_EXPIRED = 'Authentication failed: request expired';
    public const ERROR_AUTHENTICATION_FAILED__SIGNATURE_OR_SECRET_MISSING = 'Authentication failed: signature or secret missing';
    public const ERROR_AUTHENTICATION_FAILED__WORKSPACE_MISSING = 'Authentication failed: workspace missing';
    public const ERROR_AUTHENTICATION_FAILED__KEY_MISSING = 'Authentication failed: key missing';
    public const ERROR_AUTHENTICATION_FAILED__PROPERTY_ISS__ISSUER_MISSING_IN_JWT = 'Authentication failed: property iss (issuer) missing in JWT';
    public const ERROR_AUTHENTICATION_FAILED__PROPERTY_SUB__SUBJECT_MISSING_IN_JWT = 'Authentication failed: property sub (subject) missing in JWT';
    public const ERROR_AUTHENTICATION_FAILED__PROPERTY_EXP__EXPIRATION_TIME_MISSING_IN_JWT = 'Authentication failed: property exp (expiration time) missing in JWT';
    public const ERROR_AUTHENTICATION_FAILED__INVALID_ISS__ISSUER = 'Authentication failed: invalid iss (issuer)';
    public const ERROR_AUTHENTICATION_FAILED__INCORRECT_SIGNATURE = 'Authentication failed: incorrect signature';
    public const ERROR_AUTHENTICATION_FAILED = 'Authentication failed';
    ...
    {
        return [
            self::ERROR_AUTHENTICATION_FAILED__REQUEST_EXPIRED,
            self::ERROR_AUTHENTICATION_FAILED__SIGNATURE_OR_SECRET_MISSING,
            self::ERROR_AUTHENTICATION_FAILED__WORKSPACE_MISSING,
            self::ERROR_AUTHENTICATION_FAILED__KEY_MISSING,
            self::ERROR_AUTHENTICATION_FAILED__PROPERTY_ISS__ISSUER_MISSING_IN_JWT,
            self::ERROR_AUTHENTICATION_FAILED__PROPERTY_SUB__SUBJECT_MISSING_IN_JWT,
            self::ERROR_AUTHENTICATION_FAILED__PROPERTY_EXP__EXPIRATION_TIME_MISSING_IN_JWT,
            self::ERROR_AUTHENTICATION_FAILED__INVALID_ISS__ISSUER,
            self::ERROR_AUTHENTICATION_FAILED__INCORRECT_SIGNATURE,
