...
/**
 * ConvertHTML2PDFRequest Class Doc Comment
 *
 * @category Class
 * @package  PDFGeneratorAPI
 * @author   OpenAPI Generator team
 ...
 */
class ConvertHTML2PDFRequest implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'convertHTML2PDF_request';
    ...
    public const PAPER_SIZE_A0 = 'a0';
    public const PAPER_SIZE_A1 = 'a1';
    public const PAPER_SIZE_A2 = 'a2';
    public const PAPER_SIZE_A3 = 'a3';
    public const PAPER_SIZE_A4 = 'a4';
    public const PAPER_SIZE_LEGAL = 'legal';
    public const PAPER_SIZE_TABLOID = 'tabloid';
    ...
    public function __construct(array $data = null)
    {
        ...
        $this->setIfExists('orientation', $data ?? [], 'portrait');
    ...
    */
     ...
     * Sets paper_size
     *
     * @param string|null $paper_size PDF page size
     *
     * @return self
     */
    ...
    {
        $allowedValues = $this->getPaperSizeAllowableValues();
        if (!is_null($paper_size) && !in_array($paper_size, $allowedValues, true)) {
     ...
     * Sets filename
     *
     * @param string|null $filename Document name
     *
     * @return self
     */
