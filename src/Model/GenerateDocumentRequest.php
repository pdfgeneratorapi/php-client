...
/**
 * GenerateDocumentRequest Class Doc Comment
 *
 * @category Class
 * @package  PDFGeneratorAPI
 * @author   OpenAPI Generator team
 ...
 */
class GenerateDocumentRequest implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'generateDocument_request';
    ...
    protected static $openAPITypes = [
        ...
        'output' => '\PDFGeneratorAPI\Model\OutputParam',
        'name' => 'string',
        'testing' => 'bool',
    ...
    */
     ...
     * Gets output
     *
     * @return \PDFGeneratorAPI\Model\OutputParam|null
     */
     ...
     * Sets output
     *
     * @param \PDFGeneratorAPI\Model\OutputParam|null $output output
     *
     * @return self
     */
