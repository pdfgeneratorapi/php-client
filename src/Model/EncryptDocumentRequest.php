...
/**
 * EncryptDocumentRequest Class Doc Comment
 *
 * @category Class
 * @package  PDFGeneratorAPI
 * @author   OpenAPI Generator team
 ...
 */
class EncryptDocumentRequest implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'encryptDocument_request';
    ...
    public function __construct(?array $data = null)
    {
        ...
        $this->setIfExists('owner_password', $data ?? [], null);
    ...
    */
     ...
     * Sets owner_password
     *
     * @param string $owner_password An owner password to open the encrypted document
     *
     * @return self
     */
    public function setOwnerPassword($owner_password)
    {
        if (is_null($owner_password)) {
            throw new \InvalidArgumentException('non-nullable owner_password cannot be null');
        }
     ...
     * Sets user_password
     *
     * @param string|null $user_password An user password to open the encrypted document
     *
     * @return self
     */
