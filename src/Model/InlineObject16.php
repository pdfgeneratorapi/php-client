...
class InlineObject16 implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    protected static $openAPITypes = [
        'response' => '\PDFGeneratorAPI\Model\DocumentVersion[]'
    ];
    ...
    */
     ...
     * Gets response
     *
     * @return \PDFGeneratorAPI\Model\DocumentVersion[]|null
     */
     ...
     * Sets response
     *
     * @param \PDFGeneratorAPI\Model\DocumentVersion[]|null $response response
     *
     * @return self
     */
