...
/**
 * OptimizeDocument201ResponseMeta Class Doc Comment
 *
 * @category Class
 * @package  PDFGeneratorAPI
 * @author   OpenAPI Generator team
 ...
 */
class OptimizeDocument201ResponseMeta implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'optimizeDocument_201_response_meta';
    ...
    protected static $openAPITypes = [
        ...
        'encoding' => 'string',
        'content_type' => 'string',
        'stats' => '\PDFGeneratorAPI\Model\OptimizeDocument201ResponseMetaStats',
        'public_id' => 'string'
    ];
    ...
    */
     ...
     * Gets stats
     *
     * @return \PDFGeneratorAPI\Model\OptimizeDocument201ResponseMetaStats|null
     */
     ...
     * Sets stats
     *
     * @param \PDFGeneratorAPI\Model\OptimizeDocument201ResponseMetaStats|null $stats stats
     *
     * @return self
     */
     ...
     * Sets public_id
     *
     * @param string|null $public_id Document public id, if output=url was used for document storage
     *
     * @return self
     */
