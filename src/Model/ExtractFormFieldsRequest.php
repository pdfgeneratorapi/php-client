...
/**
 * ExtractFormFieldsRequest Class Doc Comment
 *
 * @category Class
 * @package  PDFGeneratorAPI
 * @author   OpenAPI Generator team
 ...
 */
class ExtractFormFieldsRequest implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'extractFormFields_request';
    ...
    protected static $openAPITypes = [
        'file_url' => 'string',
        'key_field' => '\PDFGeneratorAPI\Model\KeyFieldParam',
        'file_base64' => 'string'
    ];
    ...
    public function __construct(?array $data = null)
    {
        ...
        $this->setIfExists('key_field', $data ?? [], null);
    ...
    */
     ...
     * Gets key_field
     *
     * @return \PDFGeneratorAPI\Model\KeyFieldParam|null
     */
     ...
     * Sets key_field
     *
     * @param \PDFGeneratorAPI\Model\KeyFieldParam|null $key_field key_field
     *
     * @return self
     */
    public function setKeyField($key_field)
    {
        if (is_null($key_field)) {
            throw new \InvalidArgumentException('non-nullable key_field cannot be null');
        }
