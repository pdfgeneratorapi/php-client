 ...
 *
 * @category Class
 * @description Template object. Use the Get schema endpoint to see the detailed payload structure.
 * @package  PDFGeneratorAPI
 * @author   OpenAPI Generator team
 * @link     https://openapi-generator.tech
...
class Template implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    */
     ...
     * Sets created_at
     *
     * @param string|null $created_at Timestamp when the template was created
     *
     * @return self
     */
     ...
     * Sets updated_at
     *
     * @param string|null $updated_at Timestamp when the template was updated
     *
     * @return self
     */
