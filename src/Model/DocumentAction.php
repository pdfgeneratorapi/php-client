...
/**
 * DocumentAction Class Doc Comment
 *
 * @category Class
 * @package  PDFGeneratorAPI
 * @author   OpenAPI Generator team
 ...
 */
class DocumentAction implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'DocumentAction';
    ...
    protected static $openAPITypes = [
        'action' => 'string',
        'person' => '\PDFGeneratorAPI\Model\DocumentUser',
        'created_at' => 'string'
    ];
    ...
    */
     ...
     * Sets action
     *
     * @param string|null $action The action performed on the document.
     *
     * @return self
     */
     ...
     * Gets person
     *
     * @return \PDFGeneratorAPI\Model\DocumentUser|null
     */
     ...
     * Sets person
     *
     * @param \PDFGeneratorAPI\Model\DocumentUser|null $person person
     *
     * @return self
     */
     ...
     * Sets created_at
     *
     * @param string|null $created_at Action timestamp (Y-m-d H:i:s).
     *
     * @return self
     */
