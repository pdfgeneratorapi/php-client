...
class InlineObject10 implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    protected static $openAPITypes = [
        'response' => 'string[]',
        'meta' => '\PDFGeneratorAPI\Model\InlineObject10Meta'
    ];
    ...
    */
     ...
     * Sets response
     *
     * @param string[]|null $response Array of base64 encoded images, one per converted page.
     *
     * @return self
     */
     ...
     * Gets meta
     *
     * @return \PDFGeneratorAPI\Model\InlineObject10Meta|null
     */
     ...
     * Sets meta
     *
     * @param \PDFGeneratorAPI\Model\InlineObject10Meta|null $meta meta
     *
     * @return self
     */
