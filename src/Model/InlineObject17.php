...
class InlineObject17 implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    protected static $openAPITypes = [
        'response' => '\PDFGeneratorAPI\Model\DocumentAction[]'
    ];
    ...
    */
     ...
     * Gets response
     *
     * @return \PDFGeneratorAPI\Model\DocumentAction[]|null
     */
     ...
     * Sets response
     *
     * @param \PDFGeneratorAPI\Model\DocumentAction[]|null $response response
     *
     * @return self
     */
