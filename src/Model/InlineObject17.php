...
class InlineObject17 implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    protected static $openAPITypes = [
        'response' => '\PDFGeneratorAPI\Model\DocumentSignatures'
    ];
    ...
    */
     ...
     * Gets response
     *
     * @return \PDFGeneratorAPI\Model\DocumentSignatures|null
     */
     ...
     * Sets response
     *
     * @param \PDFGeneratorAPI\Model\DocumentSignatures|null $response response
     *
     * @return self
     */
