...
class CopyTemplateRequest implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'copyTemplate_request';
    ...
    */
     ...
     * Sets name
     *
     * @param string|null $name Name for the copied template. If name is not specified then the original name is used.
     *
     * @return self
     */
