...
/**
 * FormActionSend Class Doc Comment
 *
 * @category Class
 * @description Sends the generated document via HTTP POST request to the specified URL.
 * @package  PDFGeneratorAPI
 * @author   OpenAPI Generator team
 * @link     https://openapi-generator.tech
 * @implements \ArrayAccess<string, mixed>
 */
class FormActionSend implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'formActionSend';
