 ...
 *
 * @category Class
 * @description The user who created the version or performed the action.
 * @package  PDFGeneratorAPI
 * @author   OpenAPI Generator team
 * @link     https://openapi-generator.tech
 * @implements \ArrayAccess<string, mixed>
 */
class DocumentUser implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'DocumentUser';
    ...
    */
     ...
     * Sets id_code
     *
     * @param string|null $id_code National identification code, when provided.
     *
     * @return self
     */
    ...
    {
        if (is_null($id_code)) {
            array_push($this->openAPINullablesSetToNull, 'id_code');
        } else {
            $nullablesSetToNull = $this->getOpenAPINullablesSetToNull();
            $index = array_search('id_code', $nullablesSetToNull);
            if ($index !== FALSE) {
     ...
     * Sets ip
     *
     * @param string|null $ip IP address captured when the action was performed.
     *
     * @return self
     */
