...
class InlineObject13 implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    public const STATUS_WEBHOOK_ERROR = 'webhook_error';
    ...
    */
     ...
     * Sets job_id
     *
     * @param string|null $job_id UUID of the async job.
     *
     * @return self
     */
     ...
     * Sets status
     *
     * @param string|null $status Status of the async job.
     *
     * @return self
     */
