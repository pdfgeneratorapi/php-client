...
/**
 * GetDocument200ResponseMeta Class Doc Comment
 *
 * @category Class
 * @package  PDFGeneratorAPI
 * @author   OpenAPI Generator team
 ...
 */
class GetDocument200ResponseMeta implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'getDocument_200_response_meta';
    ...
    */
     ...
     * Sets public_id
     *
     * @param string|null $public_id Document public id
     *
     * @return self
     */
