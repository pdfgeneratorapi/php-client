...
class CreateWorkspaceRequest implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'createWorkspace_request';
    ...
    */
     ...
     * Sets identifier
     *
     * @param string|null $identifier A unique identifier of the workspace. Make sure that you can generate the same identifier for your user.
     *
     * @return self
     */
