...
/**
 * TemplateDefinitionNew Class Doc Comment
 *
 * @category Class
 * @description Template configuration. Use the Get schema endpoint to see the detailed payload structure.
 * @package  PDFGeneratorAPI
 * @author   OpenAPI Generator team
 * @link     https://openapi-generator.tech
 * @implements \ArrayAccess<string, mixed>
 */
class TemplateDefinitionNew implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'TemplateDefinitionNew';
    ...
    protected static $openAPITypes = [
        ...
        'tags' => 'string[]',
        'is_draft' => 'bool',
        'layout' => '\PDFGeneratorAPI\Model\TemplateDefinitionNewLayout',
        'pages' => '\PDFGeneratorAPI\Model\TemplateDefinitionNewPagesInner[]',
        'data_settings' => '\PDFGeneratorAPI\Model\TemplateDefinitionNewDataSettings',
        'editor' => '\PDFGeneratorAPI\Model\TemplateDefinitionNewEditor',
        'font_subsetting' => 'bool',
        'barcode_as_image' => 'bool'
    ];
    ...
    protected static $openAPIFormats = [
        ...
        'data_settings' => null,
        'editor' => null,
        'font_subsetting' => null,
        'barcode_as_image' => null
    ];
    ...
    protected static $setters = [
        ...
        'editor' => 'setEditor',
        'font_subsetting' => 'setFontSubsetting',
        'barcode_as_image' => 'setBarcodeAsImage'
    ];
    ...
    protected static $getters = [
        ...
        'editor' => 'getEditor',
        'font_subsetting' => 'getFontSubsetting',
        'barcode_as_image' => 'getBarcodeAsImage'
    ];
    ...
    public function __construct(?array $data = null)
    {
        ...
        $this->setIfExists('data_settings', $data ?? [], null);
        $this->setIfExists('editor', $data ?? [], null);
        $this->setIfExists('font_subsetting', $data ?? [], false);
        $this->setIfExists('barcode_as_image', $data ?? [], false);
    }
    ...
    */
     ...
     * Gets layout
     *
     * @return \PDFGeneratorAPI\Model\TemplateDefinitionNewLayout|null
     */
     ...
     * Sets layout
     *
     * @param \PDFGeneratorAPI\Model\TemplateDefinitionNewLayout|null $layout layout
     *
     * @return self
     */
     ...
     * Gets pages
     *
     * @return \PDFGeneratorAPI\Model\TemplateDefinitionNewPagesInner[]|null
     */
     ...
     * Sets pages
     *
     * @param \PDFGeneratorAPI\Model\TemplateDefinitionNewPagesInner[]|null $pages Defines page or label size, margins and components on page or label
     *
     * @return self
     */
     ...
     * Gets data_settings
     *
     * @return \PDFGeneratorAPI\Model\TemplateDefinitionNewDataSettings|null
     */
     ...
     * Sets data_settings
     *
     * @param \PDFGeneratorAPI\Model\TemplateDefinitionNewDataSettings|null $data_settings data_settings
     *
     * @return self
     */
    public function setDataSettings($data_settings)
    {
        if (is_null($data_settings)) {
            throw new \InvalidArgumentException('non-nullable data_settings cannot be null');
        }
     ...
     * Gets editor
     *
     * @return \PDFGeneratorAPI\Model\TemplateDefinitionNewEditor|null
     */
     ...
     * Sets editor
     *
     * @param \PDFGeneratorAPI\Model\TemplateDefinitionNewEditor|null $editor editor
     *
     * @return self
     */
    ...
    /**
     * Gets font_subsetting
     *
     * @return bool|null
     */
    public function getFontSubsetting()
    {
        return $this->container['font_subsetting'];
    }

    /**
     * Sets font_subsetting
     *
     * @param bool|null $font_subsetting If font-subsetting is applied to document when generated
     *
     * @return self
     */
    public function setFontSubsetting($font_subsetting)
    {
        if (is_null($font_subsetting)) {
            throw new \InvalidArgumentException('non-nullable font_subsetting cannot be null');
        }
        $this->container['font_subsetting'] = $font_subsetting;

        return $this;
    }

    /**
     * Gets barcode_as_image
     *
     * @return bool|null
     */
    public function getBarcodeAsImage()
    {
        return $this->container['barcode_as_image'];
    }

    /**
     * Sets barcode_as_image
     *
     * @param bool|null $barcode_as_image Defines if barcodes are rendered as raster images instead of vector graphics.
     *
     * @return self
     */
    public function setBarcodeAsImage($barcode_as_image)
    {
        if (is_null($barcode_as_image)) {
            throw new \InvalidArgumentException('non-nullable barcode_as_image cannot be null');
        }
        $this->container['barcode_as_image'] = $barcode_as_image;
