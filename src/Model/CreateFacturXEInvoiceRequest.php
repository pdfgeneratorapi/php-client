...
/**
 * CreateFacturXEInvoiceRequest Class Doc Comment
 *
 * @category Class
 * @package  PDFGeneratorAPI
 * @author   OpenAPI Generator team
 ...
 */
class CreateFacturXEInvoiceRequest implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'createFacturXEInvoice_request';
    ...
    protected static $openAPITypes = [
        'template' => '\PDFGeneratorAPI\Model\CreateFacturXEInvoiceRequestTemplate',
        'profile' => 'string',
    ...
    public function __construct(?array $data = null)
    {
        ...
        $this->setIfExists('profile', $data ?? [], 'basic');
    ...
    */
     ...
     * Gets template
     *
     * @return \PDFGeneratorAPI\Model\CreateFacturXEInvoiceRequestTemplate
     */
     ...
     * Sets template
     *
     * @param \PDFGeneratorAPI\Model\CreateFacturXEInvoiceRequestTemplate $template template
     *
     * @return self
     */
     ...
     * Sets profile
     *
     * @param string|null $profile Factur-X conformance level.
     *
     * @return self
     */
