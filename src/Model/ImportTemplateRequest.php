...
/**
 * ImportTemplateRequest Class Doc Comment
 *
 * @category Class
 * @package  PDFGeneratorAPI
 * @author   OpenAPI Generator team
 ...
 */
class ImportTemplateRequest implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'importTemplate_request';
    ...
    protected static $openAPITypes = [
        'template' => '\PDFGeneratorAPI\Model\ImportTemplateUrlTemplate',
        'file_url' => 'string',
        'file_base64' => 'string'
    ];
    ...
    */
     ...
     * Gets template
     *
     * @return \PDFGeneratorAPI\Model\ImportTemplateUrlTemplate
     */
     ...
     * Sets template
     *
     * @param \PDFGeneratorAPI\Model\ImportTemplateUrlTemplate $template template
     *
     * @return self
     */
     ...
     * Sets file_url
     *
     * @param string $file_url PDF file from remote URL to import
     *
     * @return self
     */
     ...
     * Sets file_base64
     *
     * @param string $file_base64 PDF file from base64 string to import
     *
     * @return self
     */
