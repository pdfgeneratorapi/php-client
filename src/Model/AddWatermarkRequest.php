...
/**
 * AddWatermarkRequest Class Doc Comment
 *
 * @category Class
 * @package  PDFGeneratorAPI
 * @author   OpenAPI Generator team
 ...
 */
class AddWatermarkRequest implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'addWatermark_request';
    ...
    protected static $openAPITypes = [
        'file_url' => 'string',
        'watermark' => '\PDFGeneratorAPI\Model\WatermarkFileUrlWatermark',
        'output' => 'string',
        'name' => 'string',
        'file_base64' => 'string'
    ];
    ...
    */
     ...
     * Sets file_url
     *
     * @param string $file_url PDF file from remote URL to add the watermark to
     *
     * @return self
     */
     ...
     * Gets watermark
     *
     * @return \PDFGeneratorAPI\Model\WatermarkFileUrlWatermark
     */
     ...
     * Sets watermark
     *
     * @param \PDFGeneratorAPI\Model\WatermarkFileUrlWatermark $watermark watermark
     *
     * @return self
     */
     ...
     * Sets output
     *
     * @param string|null $output Returned document output
     *
     * @return self
     */
     ...
     * Sets name
     *
     * @param string|null $name File name of the returned document
     *
     * @return self
     */
     ...
     * Sets file_base64
     *
     * @param string $file_base64 PDF file from base64 string to add the watermark to
     *
     * @return self
     */
