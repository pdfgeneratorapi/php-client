...
/**
 * FormActionSendSendDocument Class Doc Comment
 *
 * @category Class
 * @package  PDFGeneratorAPI
 * @author   OpenAPI Generator team
 ...
 */
class FormActionSendSendDocument implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'formActionSend_send_document';
    ...
    protected static $openAPITypes = [
        'url' => 'string',
        'headers' => '\PDFGeneratorAPI\Model\FormActionSendSendDocumentHeadersInner[]'
    ];
    ...
    */
     ...
     * Sets url
     *
     * @param string $url HTTPS URL where the generated document will be delivered.
     *
     * @return self
     */
     ...
     * Gets headers
     *
     * @return \PDFGeneratorAPI\Model\FormActionSendSendDocumentHeadersInner[]|null
     */
     ...
     * Sets headers
     *
     * @param \PDFGeneratorAPI\Model\FormActionSendSendDocumentHeadersInner[]|null $headers Optional HTTP headers to include with the delivery request.
     *
     * @return self
     */
