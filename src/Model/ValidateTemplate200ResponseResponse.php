...
/**
 * ValidateTemplate200ResponseResponse Class Doc Comment
 *
 * @category Class
 * @package  PDFGeneratorAPI
 * @author   OpenAPI Generator team
 ...
 */
class ValidateTemplate200ResponseResponse implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'validateTemplate_200_response_response';
    ...
    {
        $this->setIfExists('valid', $data ?? [], true);
    }
    ...
    */
     ...
     * Sets valid
     *
     * @param bool|null $valid True if template configuration was valid
     *
     * @return self
     */
