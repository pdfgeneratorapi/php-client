...
/**
 * StoreDocumentRequest Class Doc Comment
 *
 * @category Class
 * @package  PDFGeneratorAPI
 * @author   OpenAPI Generator team
 ...
 */
class StoreDocumentRequest implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'storeDocument_request';
    ...
    protected static $openAPITypes = [
        'file_base64' => 'string',
        'file_url' => 'string',
        'prefill' => '\PDFGeneratorAPI\Model\PrefillParam',
        'name' => 'string',
        'output' => 'string'
    ];
    ...
    public function __construct(?array $data = null)
    {
        ...
        $this->setIfExists('output', $data ?? [], 'url');
    }
    ...
    */
     ...
     * Gets prefill
     *
     * @return \PDFGeneratorAPI\Model\PrefillParam|null
     */
     ...
     * Sets prefill
     *
     * @param \PDFGeneratorAPI\Model\PrefillParam|null $prefill prefill
     *
     * @return self
     */
     ...
     * Sets output
     *
     * @param string|null $output Response format. `url` returns a public URL to the stored document; `viewer` returns a public URL to the PDF viewer.
     *
     * @return self
     */
