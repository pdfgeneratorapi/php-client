...
/**
 * WatermarkImage Class Doc Comment
 *
 * @category Class
 * @package  PDFGeneratorAPI
 * @author   OpenAPI Generator team
 ...
 */
class WatermarkImage implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'watermarkImage';
    ...
    */
    ...
    public function setRotation($rotation)
    {
        ...
        if (($rotation > 180)) {
            throw new \InvalidArgumentException('invalid value for $rotation when calling WatermarkImage., must be smaller than or equal to 180.');
        }
        if (($rotation < -180)) {
            throw new \InvalidArgumentException('invalid value for $rotation when calling WatermarkImage., must be bigger than or equal to -180.');
        }
    ...
    public function setScale($scale)
    {
        ...
        if (($scale > 1)) {
            throw new \InvalidArgumentException('invalid value for $scale when calling WatermarkImage., must be smaller than or equal to 1.');
        }
        if (($scale < 0.05)) {
            throw new \InvalidArgumentException('invalid value for $scale when calling WatermarkImage., must be bigger than or equal to 0.05.');
        }
