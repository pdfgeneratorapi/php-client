...
/**
 * FormConfigurationNewActionsInner Class Doc Comment
 *
 * @category Class
 * @package  PDFGeneratorAPI
 * @author   OpenAPI Generator team
 ...
 */
class FormConfigurationNewActionsInner implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'FormConfigurationNew_actions_inner';
    ...
    protected static $openAPITypes = [
        ...
        'send_document' => '\PDFGeneratorAPI\Model\FormActionSendSendDocument'
    ];
    ...
    protected static $setters = [
        'store_document' => 'setStoreDocument',
        'download_document' => 'setDownloadDocument',
        'send_document' => 'setSendDocument'
    ];
    ...
    protected static $getters = [
        'store_document' => 'getStoreDocument',
        'download_document' => 'getDownloadDocument',
        'send_document' => 'getSendDocument'
    ];
    ...
    {
        $this->setIfExists('store_document', $data ?? [], null);
        $this->setIfExists('download_document', $data ?? [], null);
        $this->setIfExists('send_document', $data ?? [], null);
    }
    ...
    */
     ...
     * @return bool|null
     */
    public function getStoreDocument()
    {
        return $this->container['store_document'];
    }

    /**
     * Sets store_document
     *
     * @param bool|null $store_document store_document
     *
     * @return self
     */
    public function setStoreDocument($store_document)
    {
        if (is_null($store_document)) {
            throw new \InvalidArgumentException('non-nullable store_document cannot be null');
        }
        $this->container['store_document'] = $store_document;

        return $this;
    }

    /**
     * Gets download_document
     *
     * @return bool|null
     */
    public function getDownloadDocument()
    {
        return $this->container['download_document'];
    }

    /**
     * Sets download_document
     *
     * @param bool|null $download_document download_document
     *
     * @return self
     */
    public function setDownloadDocument($download_document)
    {
        if (is_null($download_document)) {
            throw new \InvalidArgumentException('non-nullable download_document cannot be null');
        }
        $this->container['download_document'] = $download_document;
     ...
     * Gets send_document
     *
     * @return \PDFGeneratorAPI\Model\FormActionSendSendDocument|null
     */
    public function getSendDocument()
    {
        return $this->container['send_document'];
    }

    /**
     * Sets send_document
     *
     * @param \PDFGeneratorAPI\Model\FormActionSendSendDocument|null $send_document send_document
     *
     * @return self
     */
    public function setSendDocument($send_document)
    {
        if (is_null($send_document)) {
            throw new \InvalidArgumentException('non-nullable send_document cannot be null');
        }
        $this->container['send_document'] = $send_document;
