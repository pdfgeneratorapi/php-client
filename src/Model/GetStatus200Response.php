...
class GetStatus200Response implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    protected static $openAPITypes = [
        'api' => '\PDFGeneratorAPI\Model\StatusParam',
        'chart_api' => '\PDFGeneratorAPI\Model\StatusParam',
        'conversion_api' => '\PDFGeneratorAPI\Model\StatusParam',
        'generator_api_sync' => '\PDFGeneratorAPI\Model\StatusParam',
        'generator_api_async' => '\PDFGeneratorAPI\Model\StatusParam',
        'e_invoice' => '\PDFGeneratorAPI\Model\StatusParam'
    ];
    ...
    public function __construct(?array $data = null)
    {
        ...
        $this->setIfExists('chart_api', $data ?? [], null);
        $this->setIfExists('conversion_api', $data ?? [], null);
        $this->setIfExists('generator_api_sync', $data ?? [], null);
        $this->setIfExists('generator_api_async', $data ?? [], null);
    ...
    */
     ...
     * Gets api
     *
     * @return \PDFGeneratorAPI\Model\StatusParam|null
     */
     ...
     * Sets api
     *
     * @param \PDFGeneratorAPI\Model\StatusParam|null $api api
     *
     * @return self
     */
     ...
     * Sets chart_api
     *
     * @param \PDFGeneratorAPI\Model\StatusParam|null $chart_api chart_api
     *
     * @return self
     */
     ...
     * Sets conversion_api
     *
     * @param \PDFGeneratorAPI\Model\StatusParam|null $conversion_api conversion_api
     *
     * @return self
     */
     ...
     *
     * @param \PDFGeneratorAPI\Model\StatusParam|null $generator_api_sync generator_api_sync
     *
     * @return self
     */
     ...
     *
     * @param \PDFGeneratorAPI\Model\StatusParam|null $generator_api_async generator_api_async
     *
     * @return self
     */
     ...
     * Sets e_invoice
     *
     * @param \PDFGeneratorAPI\Model\StatusParam|null $e_invoice e_invoice
     *
     * @return self
     */
    public function setEInvoice($e_invoice)
    {
        if (is_null($e_invoice)) {
            throw new \InvalidArgumentException('non-nullable e_invoice cannot be null');
        }
