...
/**
 * OptimizeDocument201ResponseMetaStats Class Doc Comment
 *
 * @category Class
 * @package  PDFGeneratorAPI
 * @author   OpenAPI Generator team
 ...
 */
class OptimizeDocument201ResponseMetaStats implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'optimizeDocument_201_response_meta_stats';
    ...
    protected static $setters = [
        ...
        'optimized_size' => 'setOptimizedSize'
    ];
    ...
    protected static $getters = [
        ...
        'optimized_size' => 'getOptimizedSize'
    ];
    ...
    {
        $this->setIfExists('original_size', $data ?? [], null);
        $this->setIfExists('optimized_size', $data ?? [], null);
    }
    ...
    */
     ...
     * Sets original_size
     *
     * @param float|null $original_size Document original size
     *
     * @return self
     */
    public function setOriginalSize($original_size)
    {
        if (is_null($original_size)) {
            throw new \InvalidArgumentException('non-nullable original_size cannot be null');
        }
    ...
    {
        return $this->container['optimized_size'];
    }

    /**
     * Sets optimized_size
     *
     * @param float|null $optimized_size Document size after optimization
     *
     * @return self
     */
    public function setOptimizedSize($optimized_size)
    {
        if (is_null($optimized_size)) {
            throw new \InvalidArgumentException('non-nullable optimized_size cannot be null');
        }
        $this->container['optimized_size'] = $optimized_size;
