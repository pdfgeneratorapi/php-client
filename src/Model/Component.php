...
class Component implements ModelInterface, ArrayAccess
{
    ...
    {
        $this->container['cls'] = isset($data['cls']) ? $data['cls'] : null;
        ...
        $this->container['data_index'] = isset($data['data_index']) ? $data['data_index'] : null;
    }
    ...
    public function listInvalidProperties()
    {
        ...
        if (!is_null($this->container['cls']) && !in_array($this->container['cls'], $allowedValues, true)) {
            $invalidProperties[] = sprintf(
                "invalid value for 'cls', must be one of '%s'",
