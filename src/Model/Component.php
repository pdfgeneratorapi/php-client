...
class Component implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    public const CLS_TEXT_COMPONENT = 'textComponent';
    public const CLS_DATE_COMPONENT = 'dateComponent';
    public const CLS_NUMBER_COMPONENT = 'numberComponent';
    public const CLS_HTMLBLOCK_COMPONENT = 'htmlblockComponent';
