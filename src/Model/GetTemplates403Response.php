...
class GetTemplates403Response implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    public const ERROR_YOUR_ACCOUNT_HAS_EXCEEDED_THE_MONTHLY_DOCUMENT_GENERATION_LIMIT = 'Your account has exceeded the monthly document generation limit.';
    ...
    {
        return [
            self::ERROR_YOUR_ACCOUNT_HAS_EXCEEDED_THE_MONTHLY_DOCUMENT_GENERATION_LIMIT,
        ];
    }
