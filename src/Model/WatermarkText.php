...
/**
 * WatermarkText Class Doc Comment
 *
 * @category Class
 * @package  PDFGeneratorAPI
 * @author   OpenAPI Generator team
 ...
 */
class WatermarkText implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'watermarkText';
    ...
    protected static $openAPITypes = [
        ...
        'size' => 'int',
        'opacity' => 'float',
        'position' => '\PDFGeneratorAPI\Model\WatermarkPosition',
        'rotation' => 'int'
    ];
    ...
    */
    ...
    public function listInvalidProperties()
    {
        ...
        if (!is_null($this->container['size']) && ($this->container['size'] > 80)) {
            $invalidProperties[] = "invalid value for 'size', must be smaller than or equal to 80.";
        }
        ...
        if (!is_null($this->container['opacity']) && ($this->container['opacity'] < 0.1)) {
            $invalidProperties[] = "invalid value for 'opacity', must be bigger than or equal to 0.1.";
        }

        if (!is_null($this->container['rotation']) && ($this->container['rotation'] > 180)) {
            $invalidProperties[] = "invalid value for 'rotation', must be smaller than or equal to 180.";
        }

        if (!is_null($this->container['rotation']) && ($this->container['rotation'] < -180)) {
            $invalidProperties[] = "invalid value for 'rotation', must be bigger than or equal to -180.";
        }
     ...
     * Sets color
     *
     * @param string|null $color Watermark text color in hexadecimal format
     *
     * @return self
     */
     ...
     * Sets size
     *
     * @param int|null $size Watermark text font size in px
     *
     * @return self
     */
    public function setSize($size)
    {
        ...
        if (($size > 80)) {
            throw new \InvalidArgumentException('invalid value for $size when calling WatermarkText., must be smaller than or equal to 80.');
        }
        if (($size < 7)) {
            throw new \InvalidArgumentException('invalid value for $size when calling WatermarkText., must be bigger than or equal to 7.');
        }
     ...
     * Sets opacity
     *
     * @param float|null $opacity Watermark text opaxity
     *
     * @return self
     */
    public function setOpacity($opacity)
    {
        ...
        if (($opacity > 1)) {
            throw new \InvalidArgumentException('invalid value for $opacity when calling WatermarkText., must be smaller than or equal to 1.');
        }
        if (($opacity < 0.1)) {
            throw new \InvalidArgumentException('invalid value for $opacity when calling WatermarkText., must be bigger than or equal to 0.1.');
        }
     ...
     * Gets position
     *
     * @return \PDFGeneratorAPI\Model\WatermarkPosition|null
     */
     ...
     * Sets position
     *
     * @param \PDFGeneratorAPI\Model\WatermarkPosition|null $position position
     *
     * @return self
     */
     ...
     * Sets rotation
     *
     * @param int|null $rotation Watermark rotation
     *
     * @return self
     */
    public function setRotation($rotation)
    {
        ...
        if (($rotation > 180)) {
            throw new \InvalidArgumentException('invalid value for $rotation when calling WatermarkText., must be smaller than or equal to 180.');
        }
        if (($rotation < -180)) {
            throw new \InvalidArgumentException('invalid value for $rotation when calling WatermarkText., must be bigger than or equal to -180.');
        }
