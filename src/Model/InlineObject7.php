...
class InlineObject7 implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    protected static $openAPITypes = [
        'response' => '\PDFGeneratorAPI\Model\InlineObject7Response'
    ];
    ...
    */
     ...
     * Gets response
     *
     * @return \PDFGeneratorAPI\Model\InlineObject7Response|null
     */
     ...
     * Sets response
     *
     * @param \PDFGeneratorAPI\Model\InlineObject7Response|null $response response
     *
     * @return self
     */
