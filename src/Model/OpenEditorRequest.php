...
/**
 * OpenEditorRequest Class Doc Comment
 *
 * @category Class
 * @package  PDFGeneratorAPI
 * @author   OpenAPI Generator team
 ...
 */
class OpenEditorRequest implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'openEditor_request';
    ...
    protected static $openAPITypes = [
        'data' => '\PDFGeneratorAPI\Model\OpenEditorRequestData',
        'language' => 'string'
    ];
    ...
    */
     ...
     * Gets data
     *
     * @return \PDFGeneratorAPI\Model\OpenEditorRequestData|null
     */
     ...
     * Sets data
     *
     * @param \PDFGeneratorAPI\Model\OpenEditorRequestData|null $data data
     *
     * @return self
     */
     ...
     * Sets language
     *
     * @param string|null $language Specify the editor UI language. Defaults to organization editor language.
     *
     * @return self
     */
