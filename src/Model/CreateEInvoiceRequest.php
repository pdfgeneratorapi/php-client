...
/**
 * CreateEInvoiceRequest Class Doc Comment
 *
 * @category Class
 * @package  PDFGeneratorAPI
 * @author   OpenAPI Generator team
 ...
 */
class CreateEInvoiceRequest implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'createEInvoice_request';
    ...
    public function __construct(?array $data = null)
    {
        ...
        $this->setIfExists('type', $data ?? [], 'UBL');
    ...
    */
     ...
     * Sets data
     *
     * @param object $data JSON payload that represents the Peppol BIS Billing 3.0 UBL Invoice (https://docs.peppol.eu/poacc/billing/3.0/) Use the Get schema endpoint to see the detailed payload structure.
     *
     * @return self
     */
     ...
     * Sets type
     *
     * @param string|null $type Formatting type.
     *
     * @return self
     */
     ...
     * Sets output
     *
     * @param string|null $output Response format. When the \"file\" option is used the API returns the file inline.
     *
     * @return self
     */
