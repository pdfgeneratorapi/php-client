...
/**
 * AddWatermark401Response Class Doc Comment
 *
 * @category Class
 * @package  PDFGeneratorAPI
 * @author   OpenAPI Generator team
 ...
 */
class AddWatermark401Response implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'addWatermark_401_response';
    ...
    public const MESSAGE_AUTHENTICATION_FAILED__REQUEST_EXPIRED = 'Authentication failed: request expired';
    public const MESSAGE_AUTHENTICATION_FAILED__SIGNATURE_OR_SECRET_MISSING = 'Authentication failed: signature or secret missing';
    public const MESSAGE_AUTHENTICATION_FAILED__WORKSPACE_MISSING = 'Authentication failed: workspace missing';
    public const MESSAGE_AUTHENTICATION_FAILED__KEY_MISSING = 'Authentication failed: key missing';
    public const MESSAGE_AUTHENTICATION_FAILED__PROPERTY_ISS__ISSUER_MISSING_IN_JWT = 'Authentication failed: property iss (issuer) missing in JWT';
    public const MESSAGE_AUTHENTICATION_FAILED__PROPERTY_SUB__SUBJECT_MISSING_IN_JWT = 'Authentication failed: property sub (subject) missing in JWT';
    public const MESSAGE_AUTHENTICATION_FAILED__PROPERTY_EXP__EXPIRATION_TIME_MISSING_IN_JWT = 'Authentication failed: property exp (expiration time) missing in JWT';
    public const MESSAGE_AUTHENTICATION_FAILED__INVALID_ISS__ISSUER = 'Authentication failed: invalid iss (issuer)';
    public const MESSAGE_AUTHENTICATION_FAILED__INCORRECT_SIGNATURE = 'Authentication failed: incorrect signature';
    ...
    {
        return [
            self::MESSAGE_AUTHENTICATION_FAILED__REQUEST_EXPIRED,
            self::MESSAGE_AUTHENTICATION_FAILED__SIGNATURE_OR_SECRET_MISSING,
            self::MESSAGE_AUTHENTICATION_FAILED__WORKSPACE_MISSING,
            self::MESSAGE_AUTHENTICATION_FAILED__KEY_MISSING,
            self::MESSAGE_AUTHENTICATION_FAILED__PROPERTY_ISS__ISSUER_MISSING_IN_JWT,
            self::MESSAGE_AUTHENTICATION_FAILED__PROPERTY_SUB__SUBJECT_MISSING_IN_JWT,
            self::MESSAGE_AUTHENTICATION_FAILED__PROPERTY_EXP__EXPIRATION_TIME_MISSING_IN_JWT,
            self::MESSAGE_AUTHENTICATION_FAILED__INVALID_ISS__ISSUER,
            self::MESSAGE_AUTHENTICATION_FAILED__INCORRECT_SIGNATURE,
