...
/**
 * WatermarkImageContentBase64 Class Doc Comment
 *
 * @category Class
 * @package  PDFGeneratorAPI
 * @author   OpenAPI Generator team
 ...
 */
class WatermarkImageContentBase64 implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'watermarkImageContentBase64';
    ...
    */
    ...
    public function listInvalidProperties()
    {
        ...
        if (!is_null($this->container['scale']) && ($this->container['scale'] > 1)) {
            $invalidProperties[] = "invalid value for 'scale', must be smaller than or equal to 1.";
        }

        if (!is_null($this->container['scale']) && ($this->container['scale'] < 0.05)) {
            $invalidProperties[] = "invalid value for 'scale', must be bigger than or equal to 0.05.";
        }
     ...
     * Sets content_base64
     *
     * @param string $content_base64 Base64 image string
     *
     * @return self
     */
    ...
    public function setRotation($rotation)
    {
        ...
        if (($rotation > 180)) {
            throw new \InvalidArgumentException('invalid value for $rotation when calling WatermarkImageContentBase64., must be smaller than or equal to 180.');
        }
        if (($rotation < -180)) {
            throw new \InvalidArgumentException('invalid value for $rotation when calling WatermarkImageContentBase64., must be bigger than or equal to -180.');
        }
     ...
     * Sets scale
     *
     * @param float|null $scale Watermark image scale
     *
     * @return self
     */
    public function setScale($scale)
    {
        ...
        if (($scale > 1)) {
            throw new \InvalidArgumentException('invalid value for $scale when calling WatermarkImageContentBase64., must be smaller than or equal to 1.');
        }
        if (($scale < 0.05)) {
            throw new \InvalidArgumentException('invalid value for $scale when calling WatermarkImageContentBase64., must be bigger than or equal to 0.05.');
        }
