...
/**
 * MakeAccessibleRequest Class Doc Comment
 *
 * @category Class
 * @package  PDFGeneratorAPI
 * @author   OpenAPI Generator team
 ...
 */
class MakeAccessibleRequest implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'makeAccessible_request';
    ...
    protected static $openAPITypes = [
        'file_url' => 'string',
        'options' => '\PDFGeneratorAPI\Model\AccessibilityOption[]',
        'name' => 'string',
        'output' => 'string',
    ...
    public const OUTPUT_VIEWER = 'viewer';
    ...
    */
     ...
     * Sets file_url
     *
     * @param string $file_url Public URL to a PDF document
     *
     * @return self
     */
     ...
     * Gets options
     *
     * @return \PDFGeneratorAPI\Model\AccessibilityOption[]|null
     */
     ...
     * Sets options
     *
     * @param \PDFGeneratorAPI\Model\AccessibilityOption[]|null $options Accessibility processing options
     *
     * @return self
     */
     ...
     * Sets name
     *
     * @param string|null $name Name for the PDF file
     *
     * @return self
     */
     ...
     * Sets output
     *
     * @param string|null $output Returned document output format
     *
     * @return self
     */
     ...
     * Sets file_base64
     *
     * @param string $file_base64 PDF document in base64 encoded string format
     *
     * @return self
     */
