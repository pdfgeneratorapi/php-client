...
class InlineObject1 implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    protected static $openAPITypes = [
        'response' => '\PDFGeneratorAPI\Model\InlineObject1Response'
    ];
    ...
    */
     ...
     * Gets response
     *
     * @return \PDFGeneratorAPI\Model\InlineObject1Response|null
     */
     ...
     * Sets response
     *
     * @param \PDFGeneratorAPI\Model\InlineObject1Response|null $response response
     *
     * @return self
     */
