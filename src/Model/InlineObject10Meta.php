...
/**
 * InlineObject10Meta Class Doc Comment
 *
 * @category Class
 * @package  PDFGeneratorAPI
 * @author   OpenAPI Generator team
 ...
 */
class InlineObject10Meta implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'inline_object_10_meta';
    ...
    */
     ...
     * Sets name
     *
     * @param string|null $name File name with extension. Auto-generated if not provided in request.
     *
     * @return self
     */
     ...
     * Sets display_name
     *
     * @param string|null $display_name File name without extension.
     *
     * @return self
     */
     ...
     * Sets encoding
     *
     * @param string|null $encoding Encoding of the response data.
     *
     * @return self
     */
     ...
     * Sets content_type
     *
     * @param string|null $content_type Image content type.
     *
     * @return self
     */
