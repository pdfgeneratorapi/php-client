...
class InlineObject14 implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    protected static $openAPITypes = [
        'response' => 'array<string,\PDFGeneratorAPI\Model\InlineObject14ResponseValue>'
    ];
    ...
    */
     ...
     * Gets response
     *
     * @return array<string,\PDFGeneratorAPI\Model\InlineObject14ResponseValue>|null
     */
     ...
     * Sets response
     *
     * @param array<string,\PDFGeneratorAPI\Model\InlineObject14ResponseValue>|null $response Form fields extracted from the PDF document
     *
     * @return self
     */
