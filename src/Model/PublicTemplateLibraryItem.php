...
/**
 * PublicTemplateLibraryItem Class Doc Comment
 *
 * @category Class
 * @package  PDFGeneratorAPI
 * @author   OpenAPI Generator team
 ...
 */
class PublicTemplateLibraryItem implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'PublicTemplateLibraryItem';
    ...
    protected static $setters = [
        ...
        'sample_data_url' => 'setSampleDataUrl'
    ];
    ...
    protected static $getters = [
        ...
        'sample_data_url' => 'getSampleDataUrl'
    ];
    ...
    public function __construct(?array $data = null)
    {
        ...
        $this->setIfExists('sample_data_url', $data ?? [], null);
    }
    ...
    */
     ...
     * Sets id
     *
     * @param string|null $id Unique public identifier of the template
     *
     * @return self
     */
     ...
     * Sets tags
     *
     * @param string[]|null $tags A list of tags assigned to a public template
     *
     * @return self
     */
     ...
     *
     * @param string|null $preview_image_url URL to the template preview image
     *
     * @return self
     */
    public function setPreviewImageUrl($preview_image_url)
    {
        if (is_null($preview_image_url)) {
            array_push($this->openAPINullablesSetToNull, 'preview_image_url');
        } else {
            $nullablesSetToNull = $this->getOpenAPINullablesSetToNull();
            $index = array_search('preview_image_url', $nullablesSetToNull);
            if ($index !== FALSE) {
    ...
    /**
     * Gets sample_data_url
     *
     * @return string|null
     */
    public function getSampleDataUrl()
    {
        return $this->container['sample_data_url'];
    }

    /**
     * Sets sample_data_url
     *
     * @param string|null $sample_data_url URL to the template sample data
     *
     * @return self
     */
    public function setSampleDataUrl($sample_data_url)
    {
        if (is_null($sample_data_url)) {
            array_push($this->openAPINullablesSetToNull, 'sample_data_url');
        } else {
            $nullablesSetToNull = $this->getOpenAPINullablesSetToNull();
            $index = array_search('sample_data_url', $nullablesSetToNull);
            if ($index !== FALSE) {
                unset($nullablesSetToNull[$index]);
                $this->setOpenAPINullablesSetToNull($nullablesSetToNull);
            }
        }
        $this->container['sample_data_url'] = $sample_data_url;
