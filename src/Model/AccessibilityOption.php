...
/**
 * AccessibilityOption Class Doc Comment
 *
 * @category Class
 * @package  PDFGeneratorAPI
 * @author   OpenAPI Generator team
...
class AccessibilityOption
{
     ...
     */
    public const CLEAR_STRUCTURE = 'clear_structure';

    public const CLEAR_BOOKMARKS = 'clear_bookmarks';

    public const EMBED_FONT = 'embed_font';

    public const ADD_MISSING_UNICODE = 'add_missing_unicode';

    public const ADD_TAGS = 'add_tags';

    public const SET_LANGUAGE = 'set_language';

    public const SET_TITLE = 'set_title';

    public const SET_DISPLAY_DOC_TITLE = 'set_display_doc_title';

    public const SET_PDF_UA_STANDARD = 'set_pdf_ua_standard';
    ...
    public static function getAllowableEnumValues()
    {
        return [
            ...
            self::EMBED_FONT,
            self::ADD_MISSING_UNICODE,
            self::ADD_TAGS,
            self::SET_LANGUAGE,
            self::SET_TITLE,
            self::SET_DISPLAY_DOC_TITLE,
            self::SET_PDF_UA_STANDARD
        ];
    }
}
