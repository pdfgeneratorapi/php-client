...
/**
 * FormFieldsInner Class Doc Comment
 *
 * @category Class
 ...
 */
class FormFieldsInner implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'formFields_inner';
    ...
    */
     ...
     * Sets label
     *
     * @param string|null $label Field label displayed in the form
     *
     * @return self
     */
     ...
     * Sets name
     *
     * @param string|null $name Data field name. For example \"name\" can be used as \"{name}\" in the document as placeholder.
     *
     * @return self
     */
     ...
     * Sets required
     *
     * @param bool|null $required Specifies if the field is required or not
     *
     * @return self
     */
