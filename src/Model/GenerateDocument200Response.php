...
/**
 * GenerateDocument200Response Class Doc Comment
 *
 * @category Class
 * @package  PDFGeneratorAPI
 * @author   OpenAPI Generator team
 ...
 */
class GenerateDocument200Response implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'generateDocument_200_response';
    ...
    protected static $openAPITypes = [
        'response' => 'string',
        'meta' => '\PDFGeneratorAPI\Model\GenerateDocument200ResponseMeta'
    ];
    ...
    */
     ...
     * Sets response
     *
     * @param string|null $response Base64 encoded document if the output=base64 is used or URL to the document when the output=url is used.
     *
     * @return self
     */
     ...
     * Gets meta
     *
     * @return \PDFGeneratorAPI\Model\GenerateDocument200ResponseMeta|null
     */
     ...
     * Sets meta
     *
     * @param \PDFGeneratorAPI\Model\GenerateDocument200ResponseMeta|null $meta meta
     *
     * @return self
     */
