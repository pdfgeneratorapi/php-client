...
/**
 * PrefillParam Class Doc Comment
 *
 * @category Class
 * @description Viewer prefill data, encrypted into the viewer URL. Only applied when &#x60;output&#x60; is &#x60;viewer&#x60;.
 * @package  PDFGeneratorAPI
 * @author   OpenAPI Generator team
 * @link     https://openapi-generator.tech
 * @implements \ArrayAccess<string, mixed>
 */
class PrefillParam implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'prefillParam';
    ...
    public function __construct(?array $data = null)
    {
        ...
        $this->setIfExists('editable', $data ?? [], true);
    }
    ...
    */
    ...
    public function listInvalidProperties()
    {
        ...
        if (!is_null($this->container['id_code']) && (mb_strlen($this->container['id_code']) > 128)) {
            $invalidProperties[] = "invalid value for 'id_code', the character length must be smaller than or equal to 128.";
        }
        ...
        if (!is_null($this->container['signature_id']) && (mb_strlen($this->container['signature_id']) > 128)) {
            $invalidProperties[] = "invalid value for 'signature_id', the character length must be smaller than or equal to 128.";
        }
     ...
     * Sets id_code
     *
     * @param string|null $id_code id_code
     *
     * @return self
     */
    public function setIdCode($id_code)
    {
        ...
        if ((mb_strlen($id_code) > 128)) {
            throw new \InvalidArgumentException('invalid length for $id_code when calling PrefillParam., must be smaller than or equal to 128.');
        }
    ...
    public function setFirstName($first_name)
    {
        ...
        if ((mb_strlen($first_name) > 128)) {
            throw new \InvalidArgumentException('invalid length for $first_name when calling PrefillParam., must be smaller than or equal to 128.');
        }
    ...
    public function setLastName($last_name)
    {
        ...
        if ((mb_strlen($last_name) > 128)) {
            throw new \InvalidArgumentException('invalid length for $last_name when calling PrefillParam., must be smaller than or equal to 128.');
        }
    ...
    public function setEmail($email)
    {
        ...
        if ((mb_strlen($email) > 120)) {
            throw new \InvalidArgumentException('invalid length for $email when calling PrefillParam., must be smaller than or equal to 120.');
        }
    ...
    public function setSignatureId($signature_id)
    {
        ...
        if ((mb_strlen($signature_id) > 128)) {
            throw new \InvalidArgumentException('invalid length for $signature_id when calling PrefillParam., must be smaller than or equal to 128.');
        }
