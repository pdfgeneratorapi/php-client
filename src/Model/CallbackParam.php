...
/**
 * CallbackParam Class Doc Comment
 *
 * @category Class
 * @description Callback URL and optional headers
 * @package  PDFGeneratorAPI
 * @author   OpenAPI Generator team
 * @link     https://openapi-generator.tech
 * @implements \ArrayAccess<string, mixed>
 */
class CallbackParam implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'callbackParam';
    ...
    */
     ...
     * Sets url
     *
     * @param string|null $url Public callback URL that is used to make a POST request when the document is generated.
     *
     * @return self
     */
     ...
     * Sets headers
     *
     * @param object|null $headers A key-value pairs of header values sent with the POST request.
     *
     * @return self
     */
