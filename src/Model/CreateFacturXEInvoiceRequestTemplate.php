...
/**
 * CreateFacturXEInvoiceRequestTemplate Class Doc Comment
 *
 * @category Class
 * @description Template id, version, version id and data
 * @package  PDFGeneratorAPI
 * @author   OpenAPI Generator team
 * @link     https://openapi-generator.tech
 * @implements \ArrayAccess<string, mixed>
 */
class CreateFacturXEInvoiceRequestTemplate implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'createFacturXEInvoice_request_template';
    ...
    */
     ...
     * Sets version_id
     *
     * @param int|null $version_id Template version ID
     *
     * @return self
     */
     ...
     * Sets data
     *
     * @param object|null $data JSON payload that represents the Peppol BIS Billing 3.0 UBL Invoice (https://docs.peppol.eu/poacc/billing/3.0/) Use the Get schema endpoint to see the detailed payload structure.
     *
     * @return self
     */
