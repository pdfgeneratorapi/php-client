...
/**
 * TemplateDefinitionNewPagesInnerMargins Class Doc Comment
 *
 * @category Class
 * @package  PDFGeneratorAPI
 * @author   OpenAPI Generator team
 ...
 */
class TemplateDefinitionNewPagesInnerMargins implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'TemplateDefinitionNew_pages_inner_margins';
    ...
    */
     ...
     * Sets right
     *
     * @param float|null $right Page or label margin from right
     *
     * @return self
     */
     ...
     * Sets bottom
     *
     * @param float|null $bottom Page or label margin from bottom
     *
     * @return self
     */
