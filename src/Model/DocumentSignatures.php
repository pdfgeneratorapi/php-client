...
/**
 * DocumentSignatures Class Doc Comment
 *
 * @category Class
 * @package  PDFGeneratorAPI
 * @author   OpenAPI Generator team
 ...
 */
class DocumentSignatures implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'DocumentSignatures';
    ...
    protected static $openAPITypes = [
        'status' => 'string',
        'status_label' => 'string',
        'has_long_term_validation' => 'bool',
        'covers_whole_document' => 'bool',
        'document_timestamps' => 'int',
        'signatures' => '\PDFGeneratorAPI\Model\DocumentSignature[]'
    ];
    ...
    protected static $openAPIFormats = [
        'status' => null,
        'status_label' => null,
        'has_long_term_validation' => null,
        'covers_whole_document' => null,
        'document_timestamps' => null,
        'signatures' => null
    ];
    ...
    protected static array $openAPINullables = [
        'status' => false,
        'status_label' => false,
        'has_long_term_validation' => false,
        'covers_whole_document' => false,
        'document_timestamps' => false,
        'signatures' => false
    ];
    ...
    protected static $attributeMap = [
        ...
        'has_long_term_validation' => 'has_long_term_validation',
    ...
    protected static $setters = [
        ...
        'has_long_term_validation' => 'setHasLongTermValidation',
        'covers_whole_document' => 'setCoversWholeDocument',
        'document_timestamps' => 'setDocumentTimestamps',
    ...
    protected static $getters = [
        ...
        'has_long_term_validation' => 'getHasLongTermValidation',
        'covers_whole_document' => 'getCoversWholeDocument',
        'document_timestamps' => 'getDocumentTimestamps',
    ...
    public function __construct(?array $data = null)
    {
        ...
        $this->setIfExists('has_long_term_validation', $data ?? [], null);
        $this->setIfExists('covers_whole_document', $data ?? [], null);
        $this->setIfExists('document_timestamps', $data ?? [], null);
    ...
    */
     ...
     * Sets status
     *
     * @param string|null $status The one-line answer, reduced from every signature worst case first. `unavailable` means signature validation is not enabled on this deployment — it says nothing about the document.
     *
     * @return self
     */
     ...
     * Sets status_label
     *
     * @param string|null $status_label The status in words, ready to display.
     *
     * @return self
     */
    ...
    /**
     * Gets has_long_term_validation
     *
     * @return bool|null
     */
    public function getHasLongTermValidation()
    {
        return $this->container['has_long_term_validation'];
    }

    /**
     * Sets has_long_term_validation
     *
     * @param bool|null $has_long_term_validation The document carries the certificate and revocation data needed to verify it after the signing certificates expire.
     *
     * @return self
     */
    public function setHasLongTermValidation($has_long_term_validation)
    {
        if (is_null($has_long_term_validation)) {
            throw new \InvalidArgumentException('non-nullable has_long_term_validation cannot be null');
        }
        $this->container['has_long_term_validation'] = $has_long_term_validation;

        return $this;
    }

    /**
     * Gets covers_whole_document
     *
     * @return bool|null
     */
    public function getCoversWholeDocument()
    {
        return $this->container['covers_whole_document'];
    }

    /**
     * Sets covers_whole_document
     *
     * @param bool|null $covers_whole_document The last signature covers every byte, so nothing was appended after it.
     *
     * @return self
     */
    public function setCoversWholeDocument($covers_whole_document)
    {
        if (is_null($covers_whole_document)) {
            throw new \InvalidArgumentException('non-nullable covers_whole_document cannot be null');
        }
        $this->container['covers_whole_document'] = $covers_whole_document;

        return $this;
    }

    /**
     * Gets document_timestamps
     *
     * @return int|null
     */
    public function getDocumentTimestamps()
    {
        return $this->container['document_timestamps'];
    }

    /**
     * Sets document_timestamps
     *
     * @param int|null $document_timestamps Timestamp-only signatures, counted rather than listed: they are machinery, not people, and would double every signer.
     *
     * @return self
     */
    public function setDocumentTimestamps($document_timestamps)
    {
        if (is_null($document_timestamps)) {
            throw new \InvalidArgumentException('non-nullable document_timestamps cannot be null');
        }
        $this->container['document_timestamps'] = $document_timestamps;
     ...
     * Gets signatures
     *
     * @return \PDFGeneratorAPI\Model\DocumentSignature[]|null
     */
     ...
     * Sets signatures
     *
     * @param \PDFGeneratorAPI\Model\DocumentSignature[]|null $signatures One entry per signature, excluding document timestamps.
     *
     * @return self
     */
