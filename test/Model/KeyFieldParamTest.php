...
/**
 * KeyFieldParamTest Class Doc Comment
 *
 * @category    Class
 * @description Specifies which field is used to map the extract fields. If your document contains fields with the same name, then we suggest using the id field. Defaults to name.
 * @package     PDFGeneratorAPI
 * @author      OpenAPI Generator team
 * @link        https://openapi-generator.tech
 */
class KeyFieldParamTest extends TestCase
{
     ...
     * Test "KeyFieldParam"
     */
    public function testKeyFieldParam()
    {
        // TODO: implement
